...
/* chapter: 第7章課題                                     */
/* project: ps2if                                         */
/* outline: スクロールホイール・マウス対応（専用ハード版）*/
...
int main()
{
    ...
    while(1) {
        ...
        piodata2 = seg7dec((posz >> 4) & 0x0f) & 0xff;
        piodata2 = (piodata2 <<8)| (seg7dec(posz & 0x0f)        & 0xff);
