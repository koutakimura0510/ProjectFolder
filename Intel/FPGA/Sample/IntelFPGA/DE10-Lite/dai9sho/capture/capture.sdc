...
create_clock -name PCLK -period 40.000 [get_ports {GPIO[0]}]
...
set_input_delay  -clock [get_clocks $PLL0_SYSCLK] 1.5 \
  [remove_from_collection [all_inputs] {GPIO*}]
set_input_delay  -clock {PCLK}  1 [get_ports {GPIO*}]
