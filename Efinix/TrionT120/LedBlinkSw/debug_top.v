...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [16:0] la0_PRE_PROCESSER/USER_SW_WRAPPER/SW_CKE_GEN/rTmpCount,
    input  la0_PRE_PROCESSER/USER_SW_WRAPPER/wCke,
    input  vio0_clk,
    output vio0_source0
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'hbf0ca52573904fba9f1683344fa55c78 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 17 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( la0_PRE_PROCESSER/USER_SW_WRAPPER/SW_CKE_GEN/rTmpCount ),
        .probe1                 ( la0_PRE_PROCESSER/USER_SW_WRAPPER/wCke )
    );

    edb_vio_top #(
        .NUM_PROBE_IN           ( 0 ),
        .NUM_PROBE_OUT          ( 1 ),
        .UUID           ( 128'hc7b1e28c1ef24685aa7ca3feeaae45a8 ),
        .PROBE_OUT0_WIDTH       ( 1 ),
