...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  la0_memory_checker_0/r_Wcs_mon,
    input  la0_memory_checker_0/r_AWvalid_mon,
    input  la0_memory_checker_0/r_Wlast_mon,
    input  la0_memory_checker_0/r_ARready_mon,
    input  [16:0] la0_memory_checker_0/r_Rrow_mon,
    input  la0_memory_checker_0/r_Wready_mon,
    input  la0_memory_checker_0/r_ARvalid_mon,
    input  la0_memory_checker_0/r_AWready_mon,
    input  la0_memory_checker_0/r_Bready_mon,
    input  la0_memory_checker_0/r_Rready_mon,
    input  la0_memory_checker_0/r_Rcs_mon,
    input  la0_memory_checker_0/r_Wvalid_mon,
    input  [31:0] la0_memory_checker_0/r_Rdata_mon,
    input  la0_memory_checker_0/i_cfg_done,
    input  [2:0] la0_memory_checker_0/r_Wbank_mon,
    input  [16:0] la0_memory_checker_0/r_Wrow_mon,
    input  [1:0] la0_memory_checker_0/r_Bresp_mon,
    input  [2:0] la0_memory_checker_0/r_Rbank_mon,
    input  [9:0] la0_memory_checker_0/r_Rcol_mon,
    input  la0_memory_checker_0/r_Rlast_mon,
    input  [31:0] la0_memory_checker_0/r_Wdata_mon,
    input  [9:0] la0_memory_checker_0/r_Wcol_mon
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h7f401fd6fa8745ba813971d442cd3c6e ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
        ...
        .trig_out               (  ),
        .trig_out_ack           ( 1'b0 ),
        .probe0                 ( la0_memory_checker_0/r_Wcs_mon ),
        .probe1                 ( la0_memory_checker_0/r_AWvalid_mon ),
        .probe2                 ( la0_memory_checker_0/r_Wlast_mon ),
        .probe3                 ( la0_memory_checker_0/r_ARready_mon ),
        .probe4                 ( la0_memory_checker_0/r_Rrow_mon ),
        .probe5                 ( la0_memory_checker_0/r_Wready_mon ),
        .probe6                 ( la0_memory_checker_0/r_ARvalid_mon ),
        .probe7                 ( la0_memory_checker_0/r_AWready_mon ),
        .probe8                 ( la0_memory_checker_0/r_Bready_mon ),
        .probe9                 ( la0_memory_checker_0/r_Rready_mon ),
        .probe10                    ( la0_memory_checker_0/r_Rcs_mon ),
        .probe11                    ( la0_memory_checker_0/r_Wvalid_mon ),
        .probe12                    ( la0_memory_checker_0/r_Rdata_mon ),
        .probe13                    ( la0_memory_checker_0/i_cfg_done ),
        .probe14                    ( la0_memory_checker_0/r_Wbank_mon ),
        .probe15                    ( la0_memory_checker_0/r_Wrow_mon ),
        .probe16                    ( la0_memory_checker_0/r_Bresp_mon ),
        .probe17                    ( la0_memory_checker_0/r_Rbank_mon ),
        .probe18                    ( la0_memory_checker_0/r_Rcol_mon ),
        .probe19                    ( la0_memory_checker_0/r_Rlast_mon ),
        .probe20                    ( la0_memory_checker_0/r_Wdata_mon ),
        .probe21                    ( la0_memory_checker_0/r_Wcol_mon )
    );
