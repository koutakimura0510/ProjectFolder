...
module edb_top (
    ...
    input  la0_probe2,
    input  [2:0] la0_probe3,
    input  la0_probe4,
    input  la0_probe5,
    input  [255:0] la0_probe6,
    input  la0_probe7,
    input  la0_probe8,
    input  [1:0] la0_probe9,
    input  la0_probe10,
    input  la0_probe11,
    input  la0_probe12,
    input  [255:0] la0_probe13,
    input  la0_probe14,
    input  la0_probe15,
    input  [16:0] la0_probe16,
    input  [9:0] la0_probe17,
    input  [9:0] la0_probe18,
    input  la0_probe19,
    input  la0_probe20,
    input  la0_probe21,
    input  la0_probe22,
    input  [5:0] la0_probe23,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hcb136e5f24c14d15a37f450ec3f0f5d5 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 3 ),
