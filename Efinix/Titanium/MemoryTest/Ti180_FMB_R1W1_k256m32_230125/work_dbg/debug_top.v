...
module edb_top (
    ...
    input  la0_probe16,
    input  [9:0] la0_probe17,
    input  la0_probe18,
    input  [15:0] la0_probe19,
    input  [2:0] la0_probe20,
    input  la0_probe21,
    input  [15:0] la0_probe22,
    input  [15:0] la0_probe23,
    input  [2:0] la0_probe24,
    input  [16:0] la0_probe25,
    ...
    input  [1:0] la0_probe32,
    input  la0_probe33,
    input  la0_probe34,
    input  [1:0] la0_probe35,
    input  la0_probe36,
    input  la0_probe37,
    input  la0_probe38,
    input  la0_probe39,
    input  la0_probe40,
    input  [1:0] la0_probe41,
    input  la0_probe42,
    input  [5:0] la0_probe43,
    input  la0_probe44,
    input  [5:0] la0_probe45,
    input  la0_probe46,
    input  la0_probe47,
    input  la0_probe48,
    input  la0_probe49,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hfabca7bef43c4a688a409f2b66f97cc5 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 16 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 16 ),
