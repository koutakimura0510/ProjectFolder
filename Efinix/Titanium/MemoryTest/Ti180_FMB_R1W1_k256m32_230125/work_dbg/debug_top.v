...
module edb_top (
    ...
    input  la0_clk,
    input  la0_probe0,
    input  [2:0] la0_probe1,
    input  [9:0] la0_probe2,
    input  [13:0] la0_probe3,
    input  la0_probe4,
    input  la0_probe5,
    input  [1:0] la0_probe6,
    input  la0_probe7,
    input  [7:0] la0_probe8,
    input  la0_probe9,
    input  [31:0] la0_probe10,
    input  [31:0] la0_probe11,
    input  [31:0] la0_probe12,
    input  [31:0] la0_probe13,
    input  [31:0] la0_probe14,
    input  [31:0] la0_probe15,
    input  [31:0] la0_probe16,
    input  [31:0] la0_probe17,
    input  [31:0] la0_probe18,
    input  [31:0] la0_probe19,
    input  [31:0] la0_probe20,
    input  [31:0] la0_probe21,
    input  [31:0] la0_probe22,
    input  [31:0] la0_probe23,
    input  [31:0] la0_probe24,
    input  [31:0] la0_probe25,
    input  la0_probe26,
    input  la0_probe27,
    input  la0_probe28,
    input  [2:0] la0_probe29,
    input  [9:0] la0_probe30,
    input  [13:0] la0_probe31,
    input  la0_probe32,
    input  la0_probe33,
    input  [1:0] la0_probe34,
    input  la0_probe35,
    input  la0_probe36,
    input  [2:0] la0_probe37,
    input  [7:0] la0_probe38,
    input  [7:0] la0_probe39,
    input  [7:0] la0_probe40,
    input  [7:0] la0_probe41,
    input  [7:0] la0_probe42,
    input  [7:0] la0_probe43,
    input  [7:0] la0_probe44,
    input  [7:0] la0_probe45,
    input  [3:0] la0_probe46,
    input  [10:0] la0_probe47,
    input  [7:0] la0_probe48,
    input  la0_probe49,
    input  la0_probe50,
    input  [31:0] la0_probe51,
    input  [31:0] la0_probe52,
    input  [31:0] la0_probe53,
    input  [31:0] la0_probe54,
    input  [31:0] la0_probe55,
    input  [31:0] la0_probe56,
    input  [31:0] la0_probe57,
    input  [31:0] la0_probe58,
    input  [31:0] la0_probe59,
    input  [31:0] la0_probe60,
    input  [31:0] la0_probe61,
    input  [31:0] la0_probe62,
    input  [31:0] la0_probe63,
    input  [31:0] la0_probe64,
    input  [31:0] la0_probe65,
    input  [31:0] la0_probe66,
    input  la0_probe67,
    input  la0_probe68,
    input  la0_probe69,
    input  la0_probe70,
    input  la0_probe71,
    input  [7:0] la0_probe72
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'he41f4a412dfc435587a38edb624be136 ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 3 ),
