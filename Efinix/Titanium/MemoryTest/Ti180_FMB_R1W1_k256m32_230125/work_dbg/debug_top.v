...
module edb_top (
    ...
    input  la0_probe9,
    input  la0_probe10,
    input  [1:0] la0_probe11,
    input  la0_probe12,
    input  [22:0] la0_probe13,
    input  [1:0] la0_probe14,
    input  la0_probe15,
    input  la0_probe16,
    input  la0_probe17,
    input  la0_probe18,
    input  la0_probe19,
    input  la0_probe20,
    input  [5:0] la0_probe21,
    input  [5:0] la0_probe22,
    input  la0_probe23,
    input  [15:0] la0_probe24,
    input  la0_probe25,
    input  [15:0] la0_probe26,
    input  la0_probe27,
    input  [2:0] la0_probe28,
    input  [2:0] la0_probe29,
    input  la0_probe30,
    input  [15:0] la0_probe31,
    input  [15:0] la0_probe32,
    input  la0_probe33,
    input  [15:0] la0_probe34,
    input  la0_probe35,
    input  [15:0] la0_probe36,
    input  [15:0] la0_probe37,
    input  [15:0] la0_probe38,
    input  la0_probe39,
    input  la0_probe40,
    input  la0_probe41,
    input  [16:0] la0_probe42,
    input  [15:0] la0_probe43,
    input  [9:0] la0_probe44,
    input  [15:0] la0_probe45,
    input  [15:0] la0_probe46,
    input  [16:0] la0_probe47,
    input  [15:0] la0_probe48,
    input  [15:0] la0_probe49,
    input  [15:0] la0_probe50,
    input  [15:0] la0_probe51,
    input  la0_probe52,
    input  [15:0] la0_probe53,
    input  [9:0] la0_probe54,
    input  la0_probe55,
    input  la0_probe56,
    input  [15:0] la0_probe57,
    input  [15:0] la0_probe58,
    input  [15:0] la0_probe59,
    input  [15:0] la0_probe60,
    input  [15:0] la0_probe61,
    input  [15:0] la0_probe62,
    input  [15:0] la0_probe63,
    input  [15:0] la0_probe64,
    input  [15:0] la0_probe65,
    input  [15:0] la0_probe66,
    input  [15:0] la0_probe67,
    input  [15:0] la0_probe68,
    input  [15:0] la0_probe69,
    input  [15:0] la0_probe70,
    input  [15:0] la0_probe71,
    input  [15:0] la0_probe72,
    input  la0_probe73
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h4eaf5bcffbb740ea83ad1ad643a82f4e ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
