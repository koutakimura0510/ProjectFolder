...
module edb_top (
    ...
    input  [15:0] la0_probe29,
    input  la0_probe30,
    input  [15:0] la0_probe31,
    input  la0_probe32,
    input  [15:0] la0_probe33,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h8bbff7ff9a84491f98ddeab0d999ae2e ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 16 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 16 ),
