...
module edb_top (
    ...
    input  la0_probe14,
    input  la0_probe15,
    input  [15:0] la0_probe16,
    input  [3:0] la0_probe17,
    input  la0_probe18,
    input  [15:0] la0_probe19,
    input  [255:0] la0_probe20,
    input  [15:0] la0_probe21,
    input  [15:0] la0_probe22,
    input  la0_probe23,
    input  [16:0] la0_probe24,
    input  la0_probe25,
    input  la0_probe26,
    ...
    input  la0_probe31,
    input  la0_probe32,
    input  [5:0] la0_probe33,
    input  la0_probe34,
    input  [15:0] la0_probe35,
    input  la0_probe36,
    input  la0_probe37,
    input  [15:0] la0_probe38,
    input  [15:0] la0_probe39,
    input  la0_probe40,
    input  la0_probe41,
    input  [15:0] la0_probe42,
    input  la0_probe43,
    input  [15:0] la0_probe44,
    input  [15:0] la0_probe45,
    input  la0_probe46,
    input  [15:0] la0_probe47,
    input  [15:0] la0_probe48,
    input  la0_probe49,
    input  [15:0] la0_probe50,
    input  [15:0] la0_probe51,
    input  [15:0] la0_probe52,
    input  la0_probe53,
    input  [5:0] la0_probe54,
    input  [255:0] la0_probe55,
    input  [1:0] la0_probe56,
    input  [15:0] la0_probe57,
    input  [15:0] la0_probe58,
    input  [16:0] la0_probe59,
    input  la0_probe60,
    input  la0_probe61,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'hc886de518ef94b14ba7da9bfd6d3cc1a ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 16 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 16 ),
