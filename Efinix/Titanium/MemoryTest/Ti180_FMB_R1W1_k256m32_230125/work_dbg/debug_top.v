...
module edb_top (
    ...
    input  la0_clk,
    input  la0_probe0,
    input  [1:0] la0_probe1,
    input  [5:0] la0_probe2,
    input  [1:0] la0_probe3,
    input  [5:0] la0_probe4,
    input  la0_probe5,
    input  la0_probe6,
    input  la0_probe7,
    input  la0_probe8,
    ...
    input  la0_probe12,
    input  la0_probe13,
    input  [2:0] la0_probe14,
    input  [2:0] la0_probe15,
    input  [9:0] la0_probe16,
    input  [16:0] la0_probe17,
    input  [31:0] la0_probe18,
    input  la0_probe19,
    input  la0_probe20,
    input  [31:0] la0_probe21,
    input  [9:0] la0_probe22,
    input  la0_probe23,
    input  la0_probe24,
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 0 ),
        .UUID   ( 128'h942a03c2df4d4dcda3f01f538a6e9e4c ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 1 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 2 ),
