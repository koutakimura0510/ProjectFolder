...
#define VIDEO_REG_TFT_RST			(BASE_BLOCK_USI_ADRS_VTB + 0x051)
#define VIDEO_REG_TFT_WR			(BASE_BLOCK_USI_ADRS_VTB + 0x052)
#define VIDEO_REG_TFT_RD			(BASE_BLOCK_USI_ADRS_VTB + 0x053)
#define VIDEO_REG_TFT_DCX			(BASE_BLOCK_USI_ADRS_VTB + 0x054)
#define VIDEO_REG_TFT_IM			(BASE_BLOCK_USI_ADRS_VTB + 0x055)
#define VIDEO_REG_TFT_GATE			(BASE_BLOCK_USI_ADRS_VTB + 0x056)
#define VIDEO_REG_TFT_CS			(BASE_BLOCK_USI_ADRS_VTB + 0x057)
