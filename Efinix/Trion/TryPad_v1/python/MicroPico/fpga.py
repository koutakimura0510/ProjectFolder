...
TRION_PICO_IO1	= Pin(28, Pin.OUT, value=0) # USI Bus Sel
TRION_PICO_IO2	= Pin(29, Pin.OUT, value=0) # FPGA Sys RST
TRION_PICO_IO3	= Pin(6, Pin.OUT, value=0)
