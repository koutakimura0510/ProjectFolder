...
#define SYNTH_REG_DMA_ADRS_START	(BASE_BLOCK_USI_ADRS_SYNTH + 0x04)
#define SYNTH_REG_DMA_ADRS_END		(BASE_BLOCK_USI_ADRS_SYNTH + 0x08)
#define SYNTH_REG_DMA_ENABLE		(BASE_BLOCK_USI_ADRS_SYNTH + 0x0C)
#define SYNTH_REG_DMA_CYCLE_ENABLE	(BASE_BLOCK_USI_ADRS_SYNTH + 0x10)
