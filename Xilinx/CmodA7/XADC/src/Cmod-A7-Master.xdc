...
## 12 MHz Clock Signal
set_property -dict { PACKAGE_PIN L17   IOSTANDARD LVCMOS33 } [get_ports { iOscSysClk }]; #IO_L12P_T1_MRCC_14 Sch=gclk
create_clock -add -name sys_clk_pin -period 83.33 -waveform {0 41.66} [get_ports {iOscSysClk}];

## LEDs
set_property -dict { PACKAGE_PIN A17   IOSTANDARD LVCMOS33 } [get_ports { oLed[0] }]; #IO_L12N_T1_MRCC_16 Sch=oLed[1]
set_property -dict { PACKAGE_PIN C16   IOSTANDARD LVCMOS33 } [get_ports { oLed[1] }]; #IO_L13P_T2_MRCC_16 Sch=oLed[2]

## RGB oLed
#set_property -dict { PACKAGE_PIN B17   IOSTANDARD LVCMOS33 } [get_ports { oLed0_b }]; #IO_L14N_T2_SRCC_16 Sch=oLed0_b
#set_property -dict { PACKAGE_PIN B16   IOSTANDARD LVCMOS33 } [get_ports { oLed0_g }]; #IO_L13N_T2_MRCC_16 Sch=oLed0_g
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { oLed0_r }]; #IO_L14P_T2_SRCC_16 Sch=oLed0_r
