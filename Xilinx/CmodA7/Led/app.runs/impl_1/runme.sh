...
HD_PWD='D:/workspace/Xilinx/workspace/CmodA7/Led/app.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SampleTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SampleTop.tcl -notrace
