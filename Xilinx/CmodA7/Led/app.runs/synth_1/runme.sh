...
HD_PWD='D:/workspace/Xilinx/workspace/CmodA7/Led/app.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SampleTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SampleTop.tcl
