; ModuleID = '/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/animation/background_loop/background_loop/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_background_loop_ir(%struct.ap_uint* %ddr_copy, %struct.ap_uint* %ddr_update, %struct.ap_uint* nocapture readonly %width, %struct.ap_uint* nocapture readonly %height, %struct.ap_uint* nocapture readonly %frame_size, %struct.ap_uint* nocapture readonly %direction) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_background_loop_hw(%struct.ap_uint* %2, %struct.ap_uint* %3, %struct.ap_uint* %width, %struct.ap_uint* %height, %struct.ap_uint* %frame_size, %struct.ap_uint* %direction)
...
declare void @apatb_background_loop_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)

define void @background_loop_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  %6 = bitcast %struct.ap_uint* %0 to [307200 x %struct.ap_uint]*
  %7 = bitcast %struct.ap_uint* %1 to [307200 x %struct.ap_uint]*
  call void @copy_out([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %7)
  %8 = bitcast [307200 x %struct.ap_uint]* %6 to %struct.ap_uint*
  %9 = bitcast [307200 x %struct.ap_uint]* %7 to %struct.ap_uint*
  call void @background_loop_hw_stub(%struct.ap_uint* %8, %struct.ap_uint* %9, %struct.ap_uint* %2, %struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5)
  call void @copy_in([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %7)
  ret void
}

declare void @background_loop_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)
