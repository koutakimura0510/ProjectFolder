...
set ID 40
set hasByteEnable 0
set MemName background_loop_dataflow_in_loop_right_height_loop_xcopy_V_memcore
...
set MemName background_loop_dataflow_in_loop_right_height_loop_xcopy_V
...
# FIFO definition:
set ID 41
set FifoName background_loop_fifo_w32_d2_S
...
# FIFO definition:
set ID 44
set FifoName background_loop_fifo_w64_d2_S
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_y_1 \
    op interface \
    ports { y_1 { I 32 vector } y_1_ap_vld { I 1 bit } } \
} "
}
