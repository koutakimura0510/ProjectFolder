...
module background_loop_dataflow_parent_loop_proc (
        height,
        m_axi_copy_AWVALID,
        m_axi_copy_AWREADY,
        m_axi_copy_AWADDR,
...
wire    dataflow_in_loop_copy_U0_m_axi_copy_AWVALID;
wire   [63:0] dataflow_in_loop_copy_U0_m_axi_copy_AWADDR;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_AWID;
wire   [31:0] dataflow_in_loop_copy_U0_m_axi_copy_AWLEN;
wire   [2:0] dataflow_in_loop_copy_U0_m_axi_copy_AWSIZE;
wire   [1:0] dataflow_in_loop_copy_U0_m_axi_copy_AWBURST;
wire   [1:0] dataflow_in_loop_copy_U0_m_axi_copy_AWLOCK;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_AWCACHE;
wire   [2:0] dataflow_in_loop_copy_U0_m_axi_copy_AWPROT;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_AWQOS;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_AWREGION;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_AWUSER;
wire    dataflow_in_loop_copy_U0_m_axi_copy_WVALID;
wire   [31:0] dataflow_in_loop_copy_U0_m_axi_copy_WDATA;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_WSTRB;
wire    dataflow_in_loop_copy_U0_m_axi_copy_WLAST;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_WID;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_WUSER;
wire    dataflow_in_loop_copy_U0_m_axi_copy_ARVALID;
wire   [63:0] dataflow_in_loop_copy_U0_m_axi_copy_ARADDR;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_ARID;
wire   [31:0] dataflow_in_loop_copy_U0_m_axi_copy_ARLEN;
wire   [2:0] dataflow_in_loop_copy_U0_m_axi_copy_ARSIZE;
wire   [1:0] dataflow_in_loop_copy_U0_m_axi_copy_ARBURST;
wire   [1:0] dataflow_in_loop_copy_U0_m_axi_copy_ARLOCK;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_ARCACHE;
wire   [2:0] dataflow_in_loop_copy_U0_m_axi_copy_ARPROT;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_ARQOS;
wire   [3:0] dataflow_in_loop_copy_U0_m_axi_copy_ARREGION;
wire   [0:0] dataflow_in_loop_copy_U0_m_axi_copy_ARUSER;
wire    dataflow_in_loop_copy_U0_m_axi_copy_RREADY;
wire    dataflow_in_loop_copy_U0_m_axi_copy_BREADY;
wire   [9:0] dataflow_in_loop_copy_U0_ycopy_V_address0;
wire    dataflow_in_loop_copy_U0_ycopy_V_ce0;
wire   [31:0] dataflow_in_loop_copy_U0_ycopy_V_d0;
wire    dataflow_in_loop_copy_U0_ycopy_V_we0;
wire   [9:0] dataflow_in_loop_copy_U0_ycopy_V_address1;
wire    dataflow_in_loop_copy_U0_ycopy_V_ce1;
wire   [31:0] dataflow_in_loop_copy_U0_ycopy_V_d1;
wire    dataflow_in_loop_copy_U0_ycopy_V_we1;
wire    dataflow_in_loop_copy_U0_ap_start;
wire    dataflow_in_loop_copy_U0_ap_done;
wire    dataflow_in_loop_copy_U0_ap_ready;
wire    dataflow_in_loop_copy_U0_ap_idle;
reg    dataflow_in_loop_copy_U0_ap_continue;
...
wire    dataflow_in_loop_copy_U0_start_full_n;
wire    dataflow_in_loop_copy_U0_start_write;
wire    ap_ce_reg;
...
background_loop_dataflow_in_loop_copy dataflow_in_loop_copy_U0(
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~(loop_dataflow_input_count == bound_minus_1) & (ap_start == 1'b1) & (dataflow_in_loop_copy_U0_ap_ready == 1'b1))) begin
            loop_dataflow_input_count <= (loop_dataflow_input_count + 32'd1);
        end else if (((loop_dataflow_input_count == bound_minus_1) & (ap_start == 1'b1) & (dataflow_in_loop_copy_U0_ap_ready == 1'b1))) begin
            loop_dataflow_input_count <= 32'd0;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~(loop_dataflow_output_count == bound_minus_1) & (dataflow_in_loop_copy_U0_ap_continue == 1'b1) & (dataflow_in_loop_copy_U0_ap_done == 1'b1))) begin
            loop_dataflow_output_count <= (loop_dataflow_output_count + 32'd1);
        end else if (((loop_dataflow_output_count == bound_minus_1) & (dataflow_in_loop_copy_U0_ap_continue == 1'b1) & (dataflow_in_loop_copy_U0_ap_done == 1'b1))) begin
            loop_dataflow_output_count <= 32'd0;
        end
    end
end
...
always @ (*) begin
    if (((loop_dataflow_output_count == bound_minus_1) & (dataflow_in_loop_copy_U0_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = 1'b0;
    end
...
always @ (*) begin
    if (((loop_dataflow_output_count == 32'd0) & (ap_start == 1'b0) & (dataflow_in_loop_copy_U0_ap_idle == 1'b1))) begin
        ap_idle = 1'b1;
    end else begin
        ap_idle = 1'b0;
    end
...
always @ (*) begin
    if ((~(loop_dataflow_output_count == bound_minus_1) | (ap_continue == 1'b1))) begin
        dataflow_in_loop_copy_U0_ap_continue = 1'b1;
    end else begin
        dataflow_in_loop_copy_U0_ap_continue = 1'b0;
    end
end

assign ap_sync_continue = ap_continue;

assign ap_sync_done = dataflow_in_loop_copy_U0_ap_done;

assign ap_sync_ready = dataflow_in_loop_copy_U0_ap_ready;

assign bound_minus_1 = (height - 32'd1);

assign dataflow_in_loop_copy_U0_ap_start = ap_start;

assign dataflow_in_loop_copy_U0_start_full_n = 1'b1;

assign dataflow_in_loop_copy_U0_start_write = 1'b0;

assign m_axi_copy_ARADDR = dataflow_in_loop_copy_U0_m_axi_copy_ARADDR;

assign m_axi_copy_ARBURST = dataflow_in_loop_copy_U0_m_axi_copy_ARBURST;

assign m_axi_copy_ARCACHE = dataflow_in_loop_copy_U0_m_axi_copy_ARCACHE;

assign m_axi_copy_ARID = dataflow_in_loop_copy_U0_m_axi_copy_ARID;

assign m_axi_copy_ARLEN = dataflow_in_loop_copy_U0_m_axi_copy_ARLEN;

assign m_axi_copy_ARLOCK = dataflow_in_loop_copy_U0_m_axi_copy_ARLOCK;

assign m_axi_copy_ARPROT = dataflow_in_loop_copy_U0_m_axi_copy_ARPROT;

assign m_axi_copy_ARQOS = dataflow_in_loop_copy_U0_m_axi_copy_ARQOS;

assign m_axi_copy_ARREGION = dataflow_in_loop_copy_U0_m_axi_copy_ARREGION;

assign m_axi_copy_ARSIZE = dataflow_in_loop_copy_U0_m_axi_copy_ARSIZE;

assign m_axi_copy_ARUSER = dataflow_in_loop_copy_U0_m_axi_copy_ARUSER;

assign m_axi_copy_ARVALID = dataflow_in_loop_copy_U0_m_axi_copy_ARVALID;
...
assign m_axi_copy_RREADY = dataflow_in_loop_copy_U0_m_axi_copy_RREADY;
...
assign ycopy_V_address0 = dataflow_in_loop_copy_U0_ycopy_V_address0;

assign ycopy_V_address1 = 10'd0;

assign ycopy_V_ce0 = dataflow_in_loop_copy_U0_ycopy_V_ce0;

assign ycopy_V_ce1 = 1'b0;

assign ycopy_V_d0 = dataflow_in_loop_copy_U0_ycopy_V_d0;

assign ycopy_V_d1 = 32'd0;

assign ycopy_V_we0 = dataflow_in_loop_copy_U0_ycopy_V_we0;

assign ycopy_V_we1 = 1'b0;

endmodule //background_loop_dataflow_parent_loop_proc
