...
set Library     "hls"
set IPName      "display_shift"
set Version     "1.0"
set DisplayName "Display_shift"
set Revision    "2106031411"
...
set xo_kernel_name "display_shift"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/animation/display_shift/display_shift/solution1"
set debug_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/animation/display_shift/display_shift/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {display_shift_mul_34s_32ns_62_2_1
display_shift_fifo_w32_d2_S
display_shift_fifo_w32_d2_S
display_shift_fifo_w32_d2_S
display_shift_fifo_w32_d2_S
display_shift_fifo_w32_d2_S
display_shift_fifo_w64_d2_S
...
## Variables
set Top "display_shift"
set TopNoPrefix "display_shift"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ddr_copy_1 W 0x0 "Data signal of ddr_copy" {{0 32 ddr_copy W 0 "Bit 31 to 0 of ddr_copy"}}} {0x14 ddr_copy_2 W 0x0 "Data signal of ddr_copy" {{0 32 ddr_copy W 0 "Bit 63 to 32 of ddr_copy"}}} {0x1c ddr_update_1 W 0x0 "Data signal of ddr_update" {{0 32 ddr_update W 0 "Bit 31 to 0 of ddr_update"}}} {0x20 ddr_update_2 W 0x0 "Data signal of ddr_update" {{0 32 ddr_update W 0 "Bit 63 to 32 of ddr_update"}}} {0x28 width W 0x0 "Data signal of width" {{0 32 width W 0 "Bit 31 to 0 of width"}}} {0x30 height W 0x0 "Data signal of height" {{0 32 height W 0 "Bit 31 to 0 of height"}}} {0x38 xstart W 0x0 "Data signal of xstart" {{0 32 xstart W 0 "Bit 31 to 0 of xstart"}}} {0x40 xend W 0x0 "Data signal of xend" {{0 32 xend W 0 "Bit 31 to 0 of xend"}}} {0x48 ystart W 0x0 "Data signal of ystart" {{0 32 ystart W 0 "Bit 31 to 0 of ystart"}}} {0x50 yend W 0x0 "Data signal of yend" {{0 32 yend W 0 "Bit 31 to 0 of yend"}}} {0x58 frame_size W 0x0 "Data signal of frame_size" {{0 32 frame_size W 0 "Bit 31 to 0 of frame_size"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_copy m_axi_update"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_copy {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_copy"
        data_width "32"
        param_prefix "C_M_AXI_COPY"
    ...
    m_axi_update {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_update"
        data_width "32"
        param_prefix "C_M_AXI_UPDATE"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
