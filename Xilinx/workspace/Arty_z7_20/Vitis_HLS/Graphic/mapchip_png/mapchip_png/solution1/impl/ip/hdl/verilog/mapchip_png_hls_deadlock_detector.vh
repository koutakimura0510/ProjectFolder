    ...
    mapchip_png_hls_deadlock_detect_unit #(4, 0, 3, 3) mapchip_png_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_png_hls_deadlock_detect_unit #(4, 1, 3, 3) mapchip_png_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_png_hls_deadlock_detect_unit #(4, 2, 3, 3) mapchip_png_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_png_hls_deadlock_detect_unit #(4, 3, 3, 3) mapchip_png_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
...
`include "mapchip_png_hls_deadlock_report_unit.vh"
