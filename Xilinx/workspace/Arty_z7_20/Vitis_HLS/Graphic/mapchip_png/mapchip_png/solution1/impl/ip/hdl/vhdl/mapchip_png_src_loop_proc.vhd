...
entity mapchip_png_src_loop_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mapchip_png_src_loop_proc is 
...
attribute shreg_extract : string;
    ...
    signal add_ln65_fu_257_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln65_reg_356 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln65_fu_268_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    component mapchip_png_mul_32s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mul_32s_32s_32_2_1_U28 : component mapchip_png_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mul_32s_32s_32_2_1_U29 : component mapchip_png_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    mul_32ns_32ns_62_2_1_U30 : component mapchip_png_mul_32ns_32ns_62_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    add_ln65_fu_257_p2 <= std_logic_vector(unsigned(ap_phi_mux_x_phi_fu_180_p4) + unsigned(ap_const_lv32_1));
    ...
    ap_phi_mux_x_phi_fu_180_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln878_reg_361, x_reg_176, add_ln65_reg_356)
    begin
    ...
    src_V1_address0 <= zext_ln65_fu_268_p1(10 - 1 downto 0);
    ...
    zext_ln65_fu_268_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(x_reg_176_pp0_iter1_reg),64));
end behav;
