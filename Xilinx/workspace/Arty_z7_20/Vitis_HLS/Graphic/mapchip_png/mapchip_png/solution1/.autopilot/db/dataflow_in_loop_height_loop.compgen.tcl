...
set ID 81
set hasByteEnable 0
set MemName mapchip_png_dataflow_in_loop_height_loop_src_V_memcore
...
set MemName mapchip_png_dataflow_in_loop_height_loop_src_V
...
set ID 82
set hasByteEnable 0
set MemName mapchip_png_dataflow_in_loop_height_loop_dst_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 24
set AddrRange 640
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName mapchip_png_dataflow_in_loop_height_loop_dst_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 83
set FifoName mapchip_png_fifo_w32_d2_S
...
# FIFO definition:
set ID 92
set FifoName mapchip_png_fifo_w64_d2_S
...
# FIFO definition:
set ID 94
set FifoName mapchip_png_fifo_w32_d3_S
...
# FIFO definition:
set ID 96
set FifoName mapchip_png_fifo_w8_d3_S
...
# FIFO definition:
set ID 97
set FifoName mapchip_png_fifo_w64_d3_S
