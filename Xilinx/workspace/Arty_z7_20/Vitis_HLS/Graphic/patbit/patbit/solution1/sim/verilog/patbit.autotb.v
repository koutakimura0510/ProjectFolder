...
`define AUTOTB_DUT      patbit
`define AUTOTB_DUT_INST AESL_inst_patbit
`define AUTOTB_TOP      apatb_patbit_top
`define AUTOTB_LAT_RESULT_FILE "patbit.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "patbit.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_patbit_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 5.00

`define AESL_DEPTH_gmem 1
`define AESL_DEPTH_dstout 1
`define AESL_DEPTH_xpos 1
`define AESL_DEPTH_ypos 1
`define AESL_DEPTH_width 1
`define AESL_DEPTH_height 1
`define AESL_DEPTH_color 1
...
`define AUTOTB_TVIN_dstout_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_dstout.dat"
`define AUTOTB_TVIN_xpos_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_xpos.dat"
`define AUTOTB_TVIN_ypos_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_ypos.dat"
`define AUTOTB_TVIN_width_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_width.dat"
`define AUTOTB_TVIN_height_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_height.dat"
`define AUTOTB_TVIN_color_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvin_color.dat"
`define AUTOTB_TVOUT_gmem  "../tv/cdatafile/c.patbit.autotvout_gmem.dat"
`define AUTOTB_TVOUT_gmem_out_wrapc  "../tv/rtldatafile/rtl.patbit.autotvout_gmem.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 3;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 311521;
parameter LENGTH_gmem = 307200;
parameter LENGTH_dstout = 1;
parameter LENGTH_xpos = 1;
parameter LENGTH_ypos = 1;
parameter LENGTH_width = 1;
parameter LENGTH_height = 1;
parameter LENGTH_color = 1;
...
reg end_dstout;
reg [31:0] size_dstout;
reg [31:0] size_dstout_backup;
reg end_xpos;
reg [31:0] size_xpos;
reg [31:0] size_xpos_backup;
reg end_ypos;
reg [31:0] size_ypos;
reg [31:0] size_ypos_backup;
reg end_width;
reg [31:0] size_width;
