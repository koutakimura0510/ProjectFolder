...
set IPName      "patbit"
set Version     "1.0"
set DisplayName "Patbit"
set Revision    "2105250728"
...
set xo_kernel_name "patbit"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/patbit/patbit/solution1"
set debug_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/patbit/patbit/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {patbit_control_s_axi
patbit_gmem_m_axi
patbit
}
set kernel_xo ""
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 dstout_1 W 0x0 "Data signal of dstout" {{0 32 dstout W 0 "Bit 31 to 0 of dstout"}}} {0x14 dstout_2 W 0x0 "Data signal of dstout" {{0 32 dstout W 0 "Bit 63 to 32 of dstout"}}} {0x1c xpos W 0x0 "Data signal of xpos" {{0 11 xpos W 0 "Bit 10 to 0 of xpos"} {11 21 RESERVED R 0 "Reserved.  0s on read."}}} {0x24 ypos W 0x0 "Data signal of ypos" {{0 11 ypos W 0 "Bit 10 to 0 of ypos"} {11 21 RESERVED R 0 "Reserved.  0s on read."}}} {0x2c width W 0x0 "Data signal of width" {{0 11 width W 0 "Bit 10 to 0 of width"} {11 21 RESERVED R 0 "Reserved.  0s on read."}}} {0x34 height W 0x0 "Data signal of height" {{0 11 height W 0 "Bit 10 to 0 of height"} {11 21 RESERVED R 0 "Reserved.  0s on read."}}} {0x3c color W 0x0 "Data signal of color" {{0 32 color W 0 "Bit 31 to 0 of color"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
