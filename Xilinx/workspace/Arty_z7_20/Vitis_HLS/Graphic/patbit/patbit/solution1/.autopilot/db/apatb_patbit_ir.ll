; ModuleID = '/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/patbit/patbit/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
%struct.ssdm_int.2 = type { i11 }
%struct.ap_uint = type { %struct.ap_int_base }
%struct.ap_int_base = type { %struct.ssdm_int }
%struct.ssdm_int = type { i32 }

; Function Attrs: noinline
define void @apatb_patbit_ir(%struct.ap_uint* %dstout, %struct.ap_uint.0* nocapture readonly %xpos, %struct.ap_uint.0* nocapture readonly %ypos, %struct.ap_uint.0* nocapture readonly %width, %struct.ap_uint.0* nocapture readonly %height, %struct.ap_uint* nocapture readonly %color) local_unnamed_addr #0 {
entry:
  %malloccall = tail call i8* @malloc(i64 1228800)
  %dstout_copy = bitcast i8* %malloccall to [307200 x %struct.ap_uint]*
  %0 = bitcast %struct.ap_uint* %dstout to [307200 x %struct.ap_uint]*
  call fastcc void @copy_in([307200 x %struct.ap_uint]* %0, [307200 x %struct.ap_uint]* %dstout_copy)
  %1 = getelementptr inbounds [307200 x %struct.ap_uint], [307200 x %struct.ap_uint]* %dstout_copy, i32 0, i32 0
  call void @apatb_patbit_hw(%struct.ap_uint* %1, %struct.ap_uint.0* %xpos, %struct.ap_uint.0* %ypos, %struct.ap_uint.0* %width, %struct.ap_uint.0* %height, %struct.ap_uint* %color)
  call fastcc void @copy_out([307200 x %struct.ap_uint]* %0, [307200 x %struct.ap_uint]* %dstout_copy)
...
; Function Attrs: noinline
define internal fastcc void @copy_in([307200 x %struct.ap_uint]* noalias, [307200 x %struct.ap_uint]* noalias) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out([307200 x %struct.ap_uint]* noalias, [307200 x %struct.ap_uint]* noalias) unnamed_addr #5 {
entry:
...
declare void @apatb_patbit_hw(%struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint*)

define void @patbit_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint*) #6 {
entry:
  %6 = bitcast %struct.ap_uint* %0 to [307200 x %struct.ap_uint]*
  call void @copy_out([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6)
  %7 = bitcast [307200 x %struct.ap_uint]* %6 to %struct.ap_uint*
  call void @patbit_hw_stub(%struct.ap_uint* %7, %struct.ap_uint.0* %1, %struct.ap_uint.0* %2, %struct.ap_uint.0* %3, %struct.ap_uint.0* %4, %struct.ap_uint* %5)
  call void @copy_in([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6)
  ret void
}

declare void @patbit_hw_stub(%struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint.0*, %struct.ap_uint*)
