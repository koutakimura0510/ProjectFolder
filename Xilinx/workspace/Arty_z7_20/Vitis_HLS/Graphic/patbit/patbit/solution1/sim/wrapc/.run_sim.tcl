...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "patbit.autotvin.dat"
	set constFileTvOut       "patbit.autotvout.dat"
	set constFileHdlTvIn     "patbit.autohdltvin.dat"
	set constFileHdlTvOut    "patbit.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
