...
set ID 86
set hasByteEnable 0
set MemName mapchip_color_dataflow_in_loop_height_loop_src_V_memcore
...
set MemName mapchip_color_dataflow_in_loop_height_loop_src_V
...
set ID 87
set hasByteEnable 0
set MemName mapchip_color_dataflow_in_loop_height_loop_dst_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 24
set AddrRange 640
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName mapchip_color_dataflow_in_loop_height_loop_dst_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 88
set FifoName mapchip_color_fifo_w32_d2_S
...
# FIFO definition:
set ID 97
set FifoName mapchip_color_fifo_w64_d2_S
...
# FIFO definition:
set ID 99
set FifoName mapchip_color_fifo_w32_d3_S
...
# FIFO definition:
set ID 101
set FifoName mapchip_color_fifo_w24_d3_S
set InstName com_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 103
set FifoName mapchip_color_fifo_w8_d3_S
...
# FIFO definition:
set ID 104
set FifoName mapchip_color_fifo_w64_d3_S
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_com \
    op interface \
    ports { com { I 24 vector } com_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fill \
    op interface \
    ports { fill { I 24 vector } fill_ap_vld { I 1 bit } } \
} "
}
