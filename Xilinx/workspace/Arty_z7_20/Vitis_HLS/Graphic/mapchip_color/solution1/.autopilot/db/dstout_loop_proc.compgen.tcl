...
set id 57
set name mapchip_color_mul_8ns_8ns_16_1_1
...
set id 60
set name mapchip_color_mac_muladd_8ns_8ns_16ns_17_4_1
...
set id 63
set name mapchip_color_mul_mul_17ns_19ns_35_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 35
set exp i0*i1
set arg_lists {i0 {17 0 +} i1 {19 0 +} p {35 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
set id 66
set name mapchip_color_mul_mul_10ns_8ns_17_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
set out_width 17
set exp i0*i1
set arg_lists {i0 {10 0 +} i1 {8 0 +} p {17 0 +} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mul] == "ap_gen_simcore_mul"} {
eval "ap_gen_simcore_mul { \
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dst_V2 \
    op interface \
    ports { dst_V2_address0 { O 10 vector } dst_V2_ce0 { O 1 bit } dst_V2_q0 { I 24 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_com \
    op interface \
    ports { com_dout { I 24 vector } com_empty_n { I 1 bit } com_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_fill \
    op interface \
    ports { fill_dout { I 24 vector } fill_empty_n { I 1 bit } fill_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_alpha \
    op interface \
    ports { alpha_dout { I 8 vector } alpha_empty_n { I 1 bit } alpha_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dstout \
    op interface \
    ports { dstout_dout { I 64 vector } dstout_empty_n { I 1 bit } dstout_read { O 1 bit } } \
} "
}
