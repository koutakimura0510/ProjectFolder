# 1 "mapchip_color/mapchip_color.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "mapchip_color/mapchip_color.cpp" 2
...
# 9 "mapchip_color/mapchip_color.cpp" 2
...
u32 color_generate(u32 src, u32 dst, u8 alpha, u32 com, u32 fill)
{
 ...
 u32 src_g = src & 0xff;
    ...
    u32 dst_g = dst & 0xff;
    u32 com_r = (com >> 16) & 0xff;
    u32 com_b = (com >> 8) & 0xff;
    u32 com_g = com & 0xff;

    if ((src_r == com_r) && (src_b == com_b) && (src_g == com_g))
    {
        src_r = (fill >> 16) & 0xff;
        src_b = (fill >> 8) & 0xff;
        src_g = fill & 0xff;
...
__attribute__((sdx_kernel("mapchip_color", 0))) void mapchip_color(
    volatile u32 *srcin,
    volatile u32 *dstin,
    volatile u32 *dstout,
    u32 mapchip_maxwidth,
    u32 mapchip_maxheight,
    u32 mapchip_draw_xsize,
...
# 70 "mapchip_color/mapchip_color.cpp"
...
#pragma HLS INTERFACE s_axilite port=com
# 70 "mapchip_color/mapchip_color.cpp"

#pragma HLS INTERFACE s_axilite port=fill
# 70 "mapchip_color/mapchip_color.cpp"
...
#pragma HLS TOP name=mapchip_color
# 70 "mapchip_color/mapchip_color.cpp"
    ...
    {
#pragma HLS DATAFLOW
# 76 "mapchip_color/mapchip_color.cpp"
...
# 78 "mapchip_color/mapchip_color.cpp"
...
# 78 "mapchip_color/mapchip_color.cpp"
        ...
        {
#pragma HLS LOOP_TRIPCOUNT min=1 max=640 avg=240
# 83 "mapchip_color/mapchip_color.cpp"
...
# 83 "mapchip_color/mapchip_color.cpp"
        ...
        {
#pragma HLS LOOP_TRIPCOUNT min=1 max=640 avg=240
# 88 "mapchip_color/mapchip_color.cpp"

#pragma HLS PIPELINE
# 88 "mapchip_color/mapchip_color.cpp"

         dstout[x + y * frame_size] = color_generate(src[x], dst[x], alpha, com, fill);
        }
    }
}
