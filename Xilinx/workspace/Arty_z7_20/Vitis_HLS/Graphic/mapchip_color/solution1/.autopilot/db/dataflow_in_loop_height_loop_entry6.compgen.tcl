...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_com_out \
    op interface \
    ports { com_out_din { O 24 vector } com_out_full_n { I 1 bit } com_out_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_fill_out \
    op interface \
    ports { fill_out_din { O 24 vector } fill_out_full_n { I 1 bit } fill_out_write { O 1 bit } } \
} "
}
