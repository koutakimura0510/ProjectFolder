...
module mapchip_color_dataflow_in_loop_height_loop (
        ap_clk,
        ap_rst,
        mapchip_draw_xsize,
        id,
...
wire   [23:0] dataflow_in_loop_height_loop_entry6_U0_com_out_din;
wire    dataflow_in_loop_height_loop_entry6_U0_com_out_write;
wire   [23:0] dataflow_in_loop_height_loop_entry6_U0_fill_out_din;
wire    dataflow_in_loop_height_loop_entry6_U0_fill_out_write;
...
wire    dstout_loop_proc_U0_com_read;
wire    dstout_loop_proc_U0_fill_read;
...
wire    com_c_full_n;
wire   [23:0] com_c_dout;
wire    com_c_empty_n;
wire    fill_c_full_n;
wire   [23:0] fill_c_dout;
wire    fill_c_empty_n;
wire    alpha_c_full_n;
...
mapchip_color_dataflow_in_loop_height_loop_src_V #(
    .DataWidth( 32 ),
    .AddressRange( 640 ),
    .AddressWidth( 10 ))
src_V_U(
...
mapchip_color_dataflow_in_loop_height_loop_dst_V #(
    .DataWidth( 24 ),
    .AddressRange( 640 ),
    .AddressWidth( 10 ))
dst_V_U(
...
mapchip_color_dataflow_in_loop_height_loop_entry6 dataflow_in_loop_height_loop_entry6_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
mapchip_color_src_loop_proc src_loop_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
mapchip_color_dstin_loop_proc dstin_loop_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
mapchip_color_dstout_loop_proc dstout_loop_proc_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
mapchip_color_fifo_w32_d2_S mapchip_draw_xsize_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S mapchip_draw_xsize_c1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S id_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S mapchip_maxheight_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S ystart_pos_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S mapchip_maxwidth_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S xstart_pos_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S y_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S y_c2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w64_d2_S srcin_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S frame_size_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d3_S frame_size_c3_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w64_d2_S dstin_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w24_d3_S com_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w24_d3_S fill_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w8_d3_S alpha_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w64_d3_S dstout_c_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S mapchip_draw_xsize_c4_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
mapchip_color_fifo_w32_d2_S y_c5_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
endmodule //mapchip_color_dataflow_in_loop_height_loop
