...
entity mapchip_color_dstin_loop_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mapchip_color_dstin_loop_proc is 
...
attribute shreg_extract : string;
    ...
    signal add_ln82_fu_178_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln82_reg_240 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal zext_ln82_fu_193_p1 : STD_LOGIC_VECTOR (63 downto 0);
...
begin
    mul_32ns_32ns_62_2_1_U49 : component mapchip_color_mul_32ns_32ns_62_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln82_reg_240 <= add_ln82_fu_178_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    add_ln82_fu_178_p2 <= std_logic_vector(unsigned(ap_phi_mux_x_phi_fu_126_p4) + unsigned(ap_const_lv32_1));
    ...
    ap_phi_mux_x_phi_fu_126_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln878_reg_245, x_reg_122, add_ln82_reg_240)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_245 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            ap_phi_mux_x_phi_fu_126_p4 <= add_ln82_reg_240;
        else 
    ...
    dst_V2_address0 <= zext_ln82_fu_193_p1(10 - 1 downto 0);
    ...
    zext_ln82_fu_193_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(x_reg_122_pp0_iter1_reg),64));
end behav;
