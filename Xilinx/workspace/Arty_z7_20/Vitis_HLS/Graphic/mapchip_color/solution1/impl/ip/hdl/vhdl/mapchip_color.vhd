...
architecture behav of mapchip_color is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mapchip_color_mapchip_color,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=63620,HLS_SYN_TPT=none,HLS_SYN_MEM=11,HLS_SYN_DSP=0,HLS_SYN_FF=6593,HLS_SYN_LUT=5497,HLS_VERSION=2020_2}";
    ...
    signal dataflow_in_loop_height_loop_U0_com : STD_LOGIC_VECTOR (23 downto 0);
    signal dataflow_in_loop_height_loop_U0_fill : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component mapchip_color_dataflow_in_loop_height_loop IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component mapchip_color_control_s_axi IS
    generic (
    ...
    component mapchip_color_src_m_axi IS
    generic (
    ...
    component mapchip_color_dst_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    control_s_axi_U : component mapchip_color_control_s_axi
    generic map (
    ...
    src_m_axi_U : component mapchip_color_src_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dst_m_axi_U : component mapchip_color_dst_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dataflow_in_loop_height_loop_U0 : component mapchip_color_dataflow_in_loop_height_loop
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        mapchip_draw_xsize => mapchip_draw_xsize,
        ...
        com => dataflow_in_loop_height_loop_U0_com,
        fill => dataflow_in_loop_height_loop_U0_fill,
        alpha => alpha,
        dstout => dstout,
        ...
        com_ap_vld => ap_const_logic_1,
        fill_ap_vld => ap_const_logic_1,
    ...
    dataflow_in_loop_height_loop_U0_com_proc : process(com)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_com_i : integer;
    ...
    begin
        ...
        vhi_cpy := (others => '0');
        vhi_cpy(5 - 1 downto 0) := ap_const_lv32_18(5 - 1 downto 0);
        v0_cpy := com;
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_18(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for dataflow_in_loop_height_loop_U0_com_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_com_i) := com(32-1-dataflow_in_loop_height_loop_U0_com_i);
            end loop;
        end if;
        ...
        dataflow_in_loop_height_loop_U0_com <= resvalue(24-1 downto 0);
    end process;

    
    dataflow_in_loop_height_loop_U0_fill_proc : process(fill)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_fill_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_18(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for dataflow_in_loop_height_loop_U0_fill_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_fill_i) := fill(32-1-dataflow_in_loop_height_loop_U0_fill_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        dataflow_in_loop_height_loop_U0_fill <= resvalue(24-1 downto 0);
    end process;
