...
set Library     "hls"
set IPName      "mapchip_color"
set Version     "1.0"
set DisplayName "Mapchip_color"
set Revision    "2107272015"
...
set xo_kernel_name "mapchip_color"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/mapchip_color/solution1"
set debug_dir "/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/mapchip_color/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {mapchip_color_mul_32s_32s_32_2_1
...
mapchip_color_fifo_w32_d2_S
mapchip_color_fifo_w32_d2_S
mapchip_color_fifo_w64_d2_S
mapchip_color_fifo_w32_d2_S
mapchip_color_fifo_w32_d3_S
mapchip_color_fifo_w64_d2_S
mapchip_color_fifo_w24_d3_S
mapchip_color_fifo_w24_d3_S
mapchip_color_fifo_w8_d3_S
mapchip_color_fifo_w64_d3_S
mapchip_color_fifo_w32_d2_S
mapchip_color_fifo_w32_d2_S
mapchip_color_control_s_axi
mapchip_color_src_m_axi
mapchip_color_dst_m_axi
...
## Variables
set Top "mapchip_color"
set TopNoPrefix "mapchip_color"
...
set Interfaces {
    s_axi_control {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 srcin_1 W 0x0 "Data signal of srcin" {{0 32 srcin W 0 "Bit 31 to 0 of srcin"}}} {0x14 srcin_2 W 0x0 "Data signal of srcin" {{0 32 srcin W 0 "Bit 63 to 32 of srcin"}}} {0x1c dstin_1 W 0x0 "Data signal of dstin" {{0 32 dstin W 0 "Bit 31 to 0 of dstin"}}} {0x20 dstin_2 W 0x0 "Data signal of dstin" {{0 32 dstin W 0 "Bit 63 to 32 of dstin"}}} {0x28 dstout_1 W 0x0 "Data signal of dstout" {{0 32 dstout W 0 "Bit 31 to 0 of dstout"}}} {0x2c dstout_2 W 0x0 "Data signal of dstout" {{0 32 dstout W 0 "Bit 63 to 32 of dstout"}}} {0x34 mapchip_maxwidth W 0x0 "Data signal of mapchip_maxwidth" {{0 32 mapchip_maxwidth W 0 "Bit 31 to 0 of mapchip_maxwidth"}}} {0x3c mapchip_maxheight W 0x0 "Data signal of mapchip_maxheight" {{0 32 mapchip_maxheight W 0 "Bit 31 to 0 of mapchip_maxheight"}}} {0x44 mapchip_draw_xsize W 0x0 "Data signal of mapchip_draw_xsize" {{0 32 mapchip_draw_xsize W 0 "Bit 31 to 0 of mapchip_draw_xsize"}}} {0x4c mapchip_draw_ysize W 0x0 "Data signal of mapchip_draw_ysize" {{0 32 mapchip_draw_ysize W 0 "Bit 31 to 0 of mapchip_draw_ysize"}}} {0x54 xstart_pos W 0x0 "Data signal of xstart_pos" {{0 32 xstart_pos W 0 "Bit 31 to 0 of xstart_pos"}}} {0x5c ystart_pos W 0x0 "Data signal of ystart_pos" {{0 32 ystart_pos W 0 "Bit 31 to 0 of ystart_pos"}}} {0x64 frame_size W 0x0 "Data signal of frame_size" {{0 32 frame_size W 0 "Bit 31 to 0 of frame_size"}}} {0x6c alpha W 0x0 "Data signal of alpha" {{0 8 alpha W 0 "Bit 7 to 0 of alpha"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}} {0x74 fill W 0x0 "Data signal of fill" {{0 32 fill W 0 "Bit 31 to 0 of fill"}}} {0x7c com W 0x0 "Data signal of com" {{0 32 com W 0 "Bit 31 to 0 of com"}}} {0x84 id W 0x0 "Data signal of id" {{0 32 id W 0 "Bit 31 to 0 of id"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_control m_axi_src m_axi_dst"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_src {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_src"
        data_width "32"
        param_prefix "C_M_AXI_SRC"
    ...
    m_axi_dst {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_dst"
        data_width "32"
        param_prefix "C_M_AXI_DST"
        port_width "AWADDR 64 AWID 1 AWUSER 1 WDATA 32 WSTRB 4 WID 1 WUSER 1 ARADDR 64 ARID 1 ARUSER 1 RDATA 32 RID 1 RUSER 1 BID 1 BUSER 1"
        ctype {
            AWLEN {
                Type "integer unsigned"
