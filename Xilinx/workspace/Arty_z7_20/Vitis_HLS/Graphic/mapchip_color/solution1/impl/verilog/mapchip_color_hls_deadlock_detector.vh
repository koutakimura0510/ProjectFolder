    ...
    mapchip_color_hls_deadlock_detect_unit #(4, 0, 3, 3) mapchip_color_hls_deadlock_detect_unit_0 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_color_hls_deadlock_detect_unit #(4, 1, 3, 3) mapchip_color_hls_deadlock_detect_unit_1 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_color_hls_deadlock_detect_unit #(4, 2, 3, 3) mapchip_color_hls_deadlock_detect_unit_2 (
        .reset(reset),
        .clock(clock),
    ...
    mapchip_color_hls_deadlock_detect_unit #(4, 3, 3, 3) mapchip_color_hls_deadlock_detect_unit_3 (
        .reset(reset),
        .clock(clock),
    ...
    assign proc_3_data_FIFO_blk[2] = 1'b0 | (~dataflow_in_loop_height_loop_U0.dstout_loop_proc_U0.com_blk_n) | (~dataflow_in_loop_height_loop_U0.dstout_loop_proc_U0.fill_blk_n) | (~dataflow_in_loop_height_loop_U0.dstout_loop_proc_U0.alpha_blk_n) | (~dataflow_in_loop_height_loop_U0.dstout_loop_proc_U0.frame_size_blk_n) | (~dataflow_in_loop_height_loop_U0.dstout_loop_proc_U0.dstout_blk_n);
...
`include "mapchip_color_hls_deadlock_report_unit.vh"
