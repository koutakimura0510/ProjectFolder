...
module mapchip_color_src_loop_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] add_ln77_fu_257_p2;
reg   [31:0] add_ln77_reg_356;
...
mapchip_color_mul_32s_32s_32_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 32 ),
    .din1_WIDTH( 32 ),
...
assign add_ln77_fu_257_p2 = (ap_phi_mux_x_phi_fu_180_p4 + 32'd1);
...
assign src_V1_address0 = zext_ln77_fu_268_p1;
...
assign zext_ln77_fu_268_p1 = x_reg_176_pp0_iter1_reg;

endmodule //mapchip_color_src_loop_proc
