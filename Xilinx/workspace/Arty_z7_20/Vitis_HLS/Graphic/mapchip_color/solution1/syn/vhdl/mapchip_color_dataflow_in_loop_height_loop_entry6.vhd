...
entity mapchip_color_dataflow_in_loop_height_loop_entry6 is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    com : IN STD_LOGIC_VECTOR (23 downto 0);
    fill : IN STD_LOGIC_VECTOR (23 downto 0);
    ...
    com_out_din : OUT STD_LOGIC_VECTOR (23 downto 0);
    com_out_full_n : IN STD_LOGIC;
    com_out_write : OUT STD_LOGIC;
    fill_out_din : OUT STD_LOGIC_VECTOR (23 downto 0);
    fill_out_full_n : IN STD_LOGIC;
    fill_out_write : OUT STD_LOGIC;
...
architecture behav of mapchip_color_dataflow_in_loop_height_loop_entry6 is 
...
attribute shreg_extract : string;
    ...
    signal com_out_blk_n : STD_LOGIC;
    signal fill_out_blk_n : STD_LOGIC;
...
begin
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, mapchip_draw_xsize_out_full_n, mapchip_draw_xsize_out1_full_n, id_out_full_n, mapchip_maxheight_out_full_n, ystart_pos_out_full_n, mapchip_maxwidth_out_full_n, xstart_pos_out_full_n, y_out_full_n, y_out2_full_n, srcin_out_full_n, frame_size_out_full_n, frame_size_out3_full_n, dstin_out_full_n, com_out_full_n, fill_out_full_n, alpha_out_full_n, dstout_out_full_n)
    begin
        case ap_CS_fsm is
    ...
    alpha_out_write_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, mapchip_draw_xsize_out_full_n, mapchip_draw_xsize_out1_full_n, id_out_full_n, mapchip_maxheight_out_full_n, ystart_pos_out_full_n, mapchip_maxwidth_out_full_n, xstart_pos_out_full_n, y_out_full_n, y_out2_full_n, srcin_out_full_n, frame_size_out_full_n, frame_size_out3_full_n, dstin_out_full_n, com_out_full_n, fill_out_full_n, alpha_out_full_n, dstout_out_full_n)
    begin
        if ((not(((fill_out_full_n = ap_const_logic_0) or (com_out_full_n = ap_const_logic_0) or (dstin_out_full_n = ap_const_logic_0) or (frame_size_out3_full_n = ap_const_logic_0) or (frame_size_out_full_n = ap_const_logic_0) or (srcin_out_full_n = ap_const_logic_0) or (y_out2_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (y_out_full_n = ap_const_logic_0) or (xstart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxwidth_out_full_n = ap_const_logic_0) or (ystart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxheight_out_full_n = ap_const_logic_0) or (id_out_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out1_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out_full_n = ap_const_logic_0) or (ap_const_logic_0 = alpha_out_full_n) or (ap_done_reg = ap_const_logic_1) or (dstout_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    begin
                ap_block_state1 <= ((fill_out_full_n = ap_const_logic_0) or (com_out_full_n = ap_const_logic_0) or (dstin_out_full_n = ap_const_logic_0) or (frame_size_out3_full_n = ap_const_logic_0) or (frame_size_out_full_n = ap_const_logic_0) or (srcin_out_full_n = ap_const_logic_0) or (y_out2_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (y_out_full_n = ap_const_logic_0) or (xstart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxwidth_out_full_n = ap_const_logic_0) or (ystart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxheight_out_full_n = ap_const_logic_0) or (id_out_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out1_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out_full_n = ap_const_logic_0) or (ap_const_logic_0 = alpha_out_full_n) or (ap_done_reg = ap_const_logic_1) or (dstout_out_full_n = ap_const_logic_0));
    end process;
    ...
    com_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, com_out_full_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            com_out_blk_n <= com_out_full_n;
        else 
            com_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    com_out_din <= com;

    com_out_write_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, mapchip_draw_xsize_out_full_n, mapchip_draw_xsize_out1_full_n, id_out_full_n, mapchip_maxheight_out_full_n, ystart_pos_out_full_n, mapchip_maxwidth_out_full_n, xstart_pos_out_full_n, y_out_full_n, y_out2_full_n, srcin_out_full_n, frame_size_out_full_n, frame_size_out3_full_n, dstin_out_full_n, com_out_full_n, fill_out_full_n, alpha_out_full_n, dstout_out_full_n)
    begin
        if ((not(((fill_out_full_n = ap_const_logic_0) or (com_out_full_n = ap_const_logic_0) or (dstin_out_full_n = ap_const_logic_0) or (frame_size_out3_full_n = ap_const_logic_0) or (frame_size_out_full_n = ap_const_logic_0) or (srcin_out_full_n = ap_const_logic_0) or (y_out2_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (y_out_full_n = ap_const_logic_0) or (xstart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxwidth_out_full_n = ap_const_logic_0) or (ystart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxheight_out_full_n = ap_const_logic_0) or (id_out_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out1_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out_full_n = ap_const_logic_0) or (ap_const_logic_0 = alpha_out_full_n) or (ap_done_reg = ap_const_logic_1) or (dstout_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            com_out_write <= ap_const_logic_1;
        else 
            com_out_write <= ap_const_logic_0;
        end if; 
    end process;
    ...
    fill_out_blk_n_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, fill_out_full_n)
    begin
        if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            fill_out_blk_n <= fill_out_full_n;
        else 
            fill_out_blk_n <= ap_const_logic_1;
        end if; 
    end process;

    fill_out_din <= fill;

    fill_out_write_assign_proc : process(ap_start, ap_done_reg, ap_CS_fsm_state1, mapchip_draw_xsize_out_full_n, mapchip_draw_xsize_out1_full_n, id_out_full_n, mapchip_maxheight_out_full_n, ystart_pos_out_full_n, mapchip_maxwidth_out_full_n, xstart_pos_out_full_n, y_out_full_n, y_out2_full_n, srcin_out_full_n, frame_size_out_full_n, frame_size_out3_full_n, dstin_out_full_n, com_out_full_n, fill_out_full_n, alpha_out_full_n, dstout_out_full_n)
    begin
        if ((not(((fill_out_full_n = ap_const_logic_0) or (com_out_full_n = ap_const_logic_0) or (dstin_out_full_n = ap_const_logic_0) or (frame_size_out3_full_n = ap_const_logic_0) or (frame_size_out_full_n = ap_const_logic_0) or (srcin_out_full_n = ap_const_logic_0) or (y_out2_full_n = ap_const_logic_0) or (ap_start = ap_const_logic_0) or (y_out_full_n = ap_const_logic_0) or (xstart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxwidth_out_full_n = ap_const_logic_0) or (ystart_pos_out_full_n = ap_const_logic_0) or (mapchip_maxheight_out_full_n = ap_const_logic_0) or (id_out_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out1_full_n = ap_const_logic_0) or (mapchip_draw_xsize_out_full_n = ap_const_logic_0) or (ap_const_logic_0 = alpha_out_full_n) or (ap_done_reg = ap_const_logic_1) or (dstout_out_full_n = ap_const_logic_0))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
            fill_out_write <= ap_const_logic_1;
        else 
            fill_out_write <= ap_const_logic_0;
        end if; 
    end process;
