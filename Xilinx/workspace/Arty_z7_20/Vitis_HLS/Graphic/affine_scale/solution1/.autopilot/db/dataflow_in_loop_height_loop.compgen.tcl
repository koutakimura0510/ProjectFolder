...
set ID 152
set hasByteEnable 0
set MemName affine_scale_dataflow_in_loop_height_loop_src_V_memcore
...
set MemName affine_scale_dataflow_in_loop_height_loop_src_V
...
set ID 153
set hasByteEnable 0
set MemName affine_scale_dataflow_in_loop_height_loop_dst_V_memcore
set CoreName ap_simcore_mem
set PortList { 2 3 }
set DataWd 24
set AddrRange 640
...
set FullThresh 0
set CoreName ap_simcore_mem_df_channel
set MemName affine_scale_dataflow_in_loop_height_loop_dst_V
if {${::AESL::PGuard_autocg_gen} || ${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mem_df_channel] == "ap_gen_simcore_mem_df_channel"} {
    eval "ap_gen_simcore_mem_df_channel { \
    id ${ID} \
...
# FIFO definition:
set ID 154
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_draw_xsize_c_U
...
set ID 155
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_draw_xsize_c1_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 156
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_maxwidth_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 157
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_maxwidth_c2_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 158
set FifoName affine_scale_fifo_w20_d2_S
set InstName d_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
...
set ID 170
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_maxheight_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 171
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_maxheight_c9_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 177
set FifoName affine_scale_fifo_w64_d2_S
set InstName srcin_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 179
set FifoName affine_scale_fifo_w32_d3_S
set InstName frame_size_c11_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
# FIFO definition:
set ID 181
set FifoName affine_scale_fifo_w8_d3_S
...
# FIFO definition:
set ID 182
set FifoName affine_scale_fifo_w64_d3_S
set InstName dstout_c_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
set ID 183
set FifoName affine_scale_fifo_w32_d2_S
set InstName mapchip_draw_xsize_c12_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mapchip_draw_xsize { I 32 vector } mapchip_draw_xsize_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mapchip_maxwidth { I 32 vector } mapchip_maxwidth_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_d \
    op interface \
    ports { d { I 20 vector } d_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_a \
    op interface \
    ports { a { I 20 vector } a_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_c \
    op interface \
    ports { c { I 20 vector } c_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_b \
    op interface \
    ports { b { I 20 vector } b_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_m \
    op interface \
    ports { m { I 32 vector } m_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { trunc_ln69 { I 32 vector } trunc_ln69_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { mapchip_maxheight { I 32 vector } mapchip_maxheight_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_id \
    op interface \
    ports { id { I 32 vector } id_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { ystart_pos { I 32 vector } ystart_pos_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { xstart_pos { I 32 vector } xstart_pos_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_srcin \
    op interface \
    ports { srcin { I 64 vector } srcin_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dstin \
    op interface \
    ports { dstin { I 64 vector } dstin_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_alpha \
    op interface \
    ports { alpha { I 8 vector } alpha_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_dstout \
    op interface \
    ports { dstout { I 64 vector } dstout_ap_vld { I 1 bit } } \
} "
}
