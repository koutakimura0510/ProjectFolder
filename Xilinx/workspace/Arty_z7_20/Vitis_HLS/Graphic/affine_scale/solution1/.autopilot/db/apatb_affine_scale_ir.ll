...
define void @apatb_affine_scale_ir(%struct.ap_uint* %srcin, %struct.ap_uint* %dstin, %struct.ap_uint* %dstout, %struct.ap_uint* nocapture readonly %mapchip_maxwidth, %struct.ap_uint* nocapture readonly %mapchip_maxheight, %struct.ap_uint* nocapture readonly %mapchip_draw_xsize, %struct.ap_uint* nocapture readonly %mapchip_draw_ysize, %struct.ap_uint* nocapture readonly %xstart_pos, %struct.ap_uint* nocapture readonly %ystart_pos, %struct.ap_uint* nocapture readonly %frame_size, %struct.ap_uint.0* nocapture readonly %alpha, %struct.ap_uint* nocapture readonly %id, %struct.ap_uint* nocapture readonly %a, %struct.ap_uint* nocapture readonly %b, %struct.ap_uint* nocapture readonly %c, %struct.ap_uint* nocapture readonly %d, %struct.ap_uint* nocapture readonly %m, %struct.ap_uint* nocapture readonly %n) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_affine_scale_hw(%struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5, %struct.ap_uint* %mapchip_maxwidth, %struct.ap_uint* %mapchip_maxheight, %struct.ap_uint* %mapchip_draw_xsize, %struct.ap_uint* %mapchip_draw_ysize, %struct.ap_uint* %xstart_pos, %struct.ap_uint* %ystart_pos, %struct.ap_uint* %frame_size, %struct.ap_uint.0* %alpha, %struct.ap_uint* %id, %struct.ap_uint* %a, %struct.ap_uint* %b, %struct.ap_uint* %c, %struct.ap_uint* %d, %struct.ap_uint* %m, %struct.ap_uint* %n)
...
declare void @apatb_affine_scale_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)

define void @affine_scale_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  %18 = bitcast %struct.ap_uint* %0 to [307200 x %struct.ap_uint]*
  %19 = bitcast %struct.ap_uint* %1 to [307200 x %struct.ap_uint]*
  %20 = bitcast %struct.ap_uint* %2 to [307200 x %struct.ap_uint]*
  call void @copy_out([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %18, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %19, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %20)
  %21 = bitcast [307200 x %struct.ap_uint]* %18 to %struct.ap_uint*
  %22 = bitcast [307200 x %struct.ap_uint]* %19 to %struct.ap_uint*
  %23 = bitcast [307200 x %struct.ap_uint]* %20 to %struct.ap_uint*
  call void @affine_scale_hw_stub(%struct.ap_uint* %21, %struct.ap_uint* %22, %struct.ap_uint* %23, %struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5, %struct.ap_uint* %6, %struct.ap_uint* %7, %struct.ap_uint* %8, %struct.ap_uint* %9, %struct.ap_uint.0* %10, %struct.ap_uint* %11, %struct.ap_uint* %12, %struct.ap_uint* %13, %struct.ap_uint* %14, %struct.ap_uint* %15, %struct.ap_uint* %16, %struct.ap_uint* %17)
  call void @copy_in([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %18, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %19, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %20)
  ret void
}

declare void @affine_scale_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)
