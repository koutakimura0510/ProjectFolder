...
architecture behav of affine_scale is 
    ...
    signal dataflow_in_loop_height_loop_U0_d : STD_LOGIC_VECTOR (19 downto 0);
    signal dataflow_in_loop_height_loop_U0_a : STD_LOGIC_VECTOR (19 downto 0);
    signal dataflow_in_loop_height_loop_U0_c : STD_LOGIC_VECTOR (19 downto 0);
    signal dataflow_in_loop_height_loop_U0_b : STD_LOGIC_VECTOR (19 downto 0);
    ...
    component affine_scale_dataflow_in_loop_height_loop IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component affine_scale_control_s_axi IS
    generic (
    ...
    component affine_scale_src_m_axi IS
    generic (
    ...
    component affine_scale_dst_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    control_s_axi_U : component affine_scale_control_s_axi
    generic map (
    ...
    src_m_axi_U : component affine_scale_src_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dst_m_axi_U : component affine_scale_dst_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dataflow_in_loop_height_loop_U0 : component affine_scale_dataflow_in_loop_height_loop
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        mapchip_draw_xsize => mapchip_draw_xsize,
    ...
    dataflow_in_loop_height_loop_U0_a_proc : process(a)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_a_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            ...
            for dataflow_in_loop_height_loop_U0_a_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_a_i) := a(32-1-dataflow_in_loop_height_loop_U0_a_i);
            end loop;
        end if;
        ...
        dataflow_in_loop_height_loop_U0_a <= resvalue(20-1 downto 0);
    end process;

    dataflow_in_loop_height_loop_U0_ap_continue <= ap_const_logic_1;
    dataflow_in_loop_height_loop_U0_ap_start <= ap_start;
    
    dataflow_in_loop_height_loop_U0_b_proc : process(b)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_b_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_14(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for dataflow_in_loop_height_loop_U0_b_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_b_i) := b(32-1-dataflow_in_loop_height_loop_U0_b_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        dataflow_in_loop_height_loop_U0_b <= resvalue(20-1 downto 0);
    end process;

    
    dataflow_in_loop_height_loop_U0_c_proc : process(c)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_c_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_14(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for dataflow_in_loop_height_loop_U0_c_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_c_i) := c(32-1-dataflow_in_loop_height_loop_U0_c_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        dataflow_in_loop_height_loop_U0_c <= resvalue(20-1 downto 0);
    end process;

    
    dataflow_in_loop_height_loop_U0_d_proc : process(d)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_d_i : integer;
    variable section : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable tmp_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable resvalue, res_value, res_mask : STD_LOGIC_VECTOR(32 - 1 downto 0);
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            vhi_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_14(5-1 downto 0)));
            vlo_cpy(5-1 downto 0) := std_logic_vector(32-1-unsigned(ap_const_lv32_0(5-1 downto 0)));
            for dataflow_in_loop_height_loop_U0_d_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_d_i) := d(32-1-dataflow_in_loop_height_loop_U0_d_i);
            end loop;
        end if;
        res_value := std_logic_vector(shift_right(unsigned(v0_cpy), to_integer(unsigned('0' & vlo_cpy(5-1 downto 0)))));
        ...
        res_mask := res_mask(32-2 downto 0) & '0';
        resvalue := res_value and not res_mask;
        dataflow_in_loop_height_loop_U0_d <= resvalue(20-1 downto 0);
    end process;
