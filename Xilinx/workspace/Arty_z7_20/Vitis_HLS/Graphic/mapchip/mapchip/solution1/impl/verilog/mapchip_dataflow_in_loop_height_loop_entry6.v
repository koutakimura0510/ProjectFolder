...
module mapchip_dataflow_in_loop_height_loop_entry6 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [23:0] crip_out_din;
input   crip_out_full_n;
output   crip_out_write;
...
always @ (*) begin
    ap_block_state1 = ((crip_out_full_n == 1'b0) | (dstout_out_full_n == 1'b0) | (dstin_out_full_n == 1'b0) | (frame_size_out3_full_n == 1'b0) | (frame_size_out_full_n == 1'b0) | (srcin_out_full_n == 1'b0) | (y_out2_full_n == 1'b0) | (ap_start == 1'b0) | (y_out_full_n == 1'b0) | (xstart_pos_out_full_n == 1'b0) | (mapchip_maxwidth_out_full_n == 1'b0) | (ystart_pos_out_full_n == 1'b0) | (mapchip_maxheight_out_full_n == 1'b0) | (id_out_full_n == 1'b0) | (mapchip_draw_xsize_out1_full_n == 1'b0) | (mapchip_draw_xsize_out_full_n == 1'b0) | (1'b0 == alpha_out_full_n) | (ap_done_reg == 1'b1));
end

assign crip_out_din = crip;
...
endmodule //mapchip_dataflow_in_loop_height_loop_entry6
