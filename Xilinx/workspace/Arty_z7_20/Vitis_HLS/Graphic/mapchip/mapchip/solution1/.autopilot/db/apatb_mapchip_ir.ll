; ModuleID = '/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Graphic/mapchip/mapchip/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_mapchip_ir(%struct.ap_uint* %srcin, %struct.ap_uint* %dstin, %struct.ap_uint* %dstout, %struct.ap_uint* nocapture readonly %mapchip_maxwidth, %struct.ap_uint* nocapture readonly %mapchip_maxheight, %struct.ap_uint* nocapture readonly %mapchip_draw_xsize, %struct.ap_uint* nocapture readonly %mapchip_draw_ysize, %struct.ap_uint* nocapture readonly %xstart_pos, %struct.ap_uint* nocapture readonly %ystart_pos, %struct.ap_uint* nocapture readonly %frame_size, %struct.ap_uint.0* nocapture readonly %alpha, %struct.ap_uint* nocapture readonly %id, %struct.ap_uint* nocapture readonly %crip) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mapchip_hw(%struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5, %struct.ap_uint* %mapchip_maxwidth, %struct.ap_uint* %mapchip_maxheight, %struct.ap_uint* %mapchip_draw_xsize, %struct.ap_uint* %mapchip_draw_ysize, %struct.ap_uint* %xstart_pos, %struct.ap_uint* %ystart_pos, %struct.ap_uint* %frame_size, %struct.ap_uint.0* %alpha, %struct.ap_uint* %id, %struct.ap_uint* %crip)
...
declare void @apatb_mapchip_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*)

define void @mapchip_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  %13 = bitcast %struct.ap_uint* %0 to [307200 x %struct.ap_uint]*
  %14 = bitcast %struct.ap_uint* %1 to [307200 x %struct.ap_uint]*
  %15 = bitcast %struct.ap_uint* %2 to [307200 x %struct.ap_uint]*
  call void @copy_out([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %13, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %14, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %15)
  %16 = bitcast [307200 x %struct.ap_uint]* %13 to %struct.ap_uint*
  %17 = bitcast [307200 x %struct.ap_uint]* %14 to %struct.ap_uint*
  %18 = bitcast [307200 x %struct.ap_uint]* %15 to %struct.ap_uint*
  call void @mapchip_hw_stub(%struct.ap_uint* %16, %struct.ap_uint* %17, %struct.ap_uint* %18, %struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5, %struct.ap_uint* %6, %struct.ap_uint* %7, %struct.ap_uint* %8, %struct.ap_uint* %9, %struct.ap_uint.0* %10, %struct.ap_uint* %11, %struct.ap_uint* %12)
  call void @copy_in([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %13, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %14, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %15)
  ret void
}

declare void @mapchip_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*, %struct.ap_uint*, %struct.ap_uint*)
