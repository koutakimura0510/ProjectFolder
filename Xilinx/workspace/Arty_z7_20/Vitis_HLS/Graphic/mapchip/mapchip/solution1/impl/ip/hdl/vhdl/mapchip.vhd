...
architecture behav of mapchip is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "mapchip_mapchip,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020-clg400-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.300000,HLS_SYN_LAT=62180,HLS_SYN_TPT=none,HLS_SYN_MEM=11,HLS_SYN_DSP=0,HLS_SYN_FF=6739,HLS_SYN_LUT=5373,HLS_VERSION=2020_2}";
    ...
    signal crip : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dataflow_in_loop_height_loop_U0_crip : STD_LOGIC_VECTOR (23 downto 0);
    ...
    component mapchip_dataflow_in_loop_height_loop IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
    ...
    component mapchip_control_s_axi IS
    generic (
    ...
    component mapchip_src_m_axi IS
    generic (
    ...
    component mapchip_dst_m_axi IS
    generic (
        CONSERVATIVE : INTEGER;
        USER_DW : INTEGER;
        USER_AW : INTEGER;
...
begin
    control_s_axi_U : component mapchip_control_s_axi
    generic map (
    ...
    src_m_axi_U : component mapchip_src_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dst_m_axi_U : component mapchip_dst_m_axi
    generic map (
        CONSERVATIVE => 0,
        USER_DW => 32,
        USER_AW => 64,
    ...
    dataflow_in_loop_height_loop_U0 : component mapchip_dataflow_in_loop_height_loop
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst_n_inv,
        mapchip_draw_xsize => mapchip_draw_xsize,
        ...
        dstout => dstout,
        crip => dataflow_in_loop_height_loop_U0_crip,
        alpha => alpha,
    ...
    dataflow_in_loop_height_loop_U0_crip_proc : process(crip)
    variable vlo_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable vhi_cpy : STD_LOGIC_VECTOR(32+32 - 1 downto 0);
    variable v0_cpy : STD_LOGIC_VECTOR(32 - 1 downto 0);
    variable dataflow_in_loop_height_loop_U0_crip_i : integer;
    ...
    begin
        ...
        if (vlo_cpy(5 - 1 downto 0) > vhi_cpy(5 - 1 downto 0)) then
            ...
            for dataflow_in_loop_height_loop_U0_crip_i in 0 to 32-1 loop
                v0_cpy(dataflow_in_loop_height_loop_U0_crip_i) := crip(32-1-dataflow_in_loop_height_loop_U0_crip_i);
            end loop;
        end if;
        ...
        dataflow_in_loop_height_loop_U0_crip <= resvalue(24-1 downto 0);
    end process;
