...
set C_modelArgList {
	...
	{ dst_V2 int 32 regular {array 640 { 0 3 } 0 1 }  }
}
set C_modelArgMapList {[ 
	{ "Name" : "mapchip_draw_xsize", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_V2", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ dst_V2_d0 sc_out sc_lv 32 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_V2_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_V2", "role": "d0" }}  ]}
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_62_2_1_U47", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	dst_V2 { ap_memory {  { dst_V2_address0 mem_address 1 10 }  { dst_V2_ce0 mem_ce 1 1 }  { dst_V2_we0 mem_we 1 1 }  { dst_V2_d0 mem_din 1 32 } } }
}
