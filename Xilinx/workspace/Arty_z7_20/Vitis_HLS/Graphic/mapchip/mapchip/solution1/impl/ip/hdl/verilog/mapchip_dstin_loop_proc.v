...
module mapchip_dstin_loop_proc (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
reg   [31:0] mapchip_draw_xsize_read_reg_194;
reg   [31:0] y_read_reg_200;
reg   [31:0] frame_size_read_reg_205;
reg   [63:0] dstin_read_reg_210;
wire    ap_CS_fsm_state2;
wire   [61:0] grp_fu_140_p2;
reg   [61:0] mul_i_i70_i_reg_225;
wire    ap_CS_fsm_state3;
reg   [63:0] dst_addr_reg_230;
wire    ap_CS_fsm_state4;
wire   [31:0] add_ln78_fu_178_p2;
reg   [31:0] add_ln78_reg_236;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] icmp_ln878_fu_184_p2;
reg   [0:0] icmp_ln878_reg_241_pp0_iter1_reg;
reg   [31:0] dst_addr_read_reg_245;
wire    ap_CS_fsm_state11;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state12;
reg    ap_enable_reg_pp0_iter2;
reg   [31:0] ap_phi_mux_x_phi_fu_126_p4;
wire   [63:0] zext_ln78_fu_189_p1;
...
wire   [61:0] trunc_ln324_3_fu_158_p4;
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state11)) begin
        x_reg_122 <= 32'd0;
    end else if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln878_reg_241 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln878_reg_241 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln878_reg_241 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln878_reg_241_pp0_iter1_reg == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        dst_V2_we0 = 1'b1;
    end else begin
        dst_V2_we0 = 1'b0;
    end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln878_reg_241 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
assign add_ln324_fu_153_p2 = (dstin_read_reg_210 + shl_ln324_2_fu_146_p3);

assign add_ln78_fu_178_p2 = (ap_phi_mux_x_phi_fu_126_p4 + 32'd1);
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_dst_RVALID == 1'b0) & (icmp_ln878_reg_241 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_dst_RVALID == 1'b0) & (icmp_ln878_reg_241 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state13_pp0_stage0_iter1 = ((m_axi_dst_RVALID == 1'b0) & (icmp_ln878_reg_241 == 1'd0));
end
...
assign dst_V2_address0 = zext_ln78_fu_189_p1;

assign dst_V2_d0 = dst_addr_read_reg_245;

assign grp_fu_140_p0 = grp_fu_140_p00;

assign grp_fu_140_p00 = y_read_reg_200;

assign grp_fu_140_p1 = grp_fu_140_p10;

assign grp_fu_140_p10 = frame_size_read_reg_205;

assign icmp_ln878_fu_184_p2 = ((ap_phi_mux_x_phi_fu_126_p4 == mapchip_draw_xsize_read_reg_194) ? 1'b1 : 1'b0);

assign m_axi_dst_ARADDR = dst_addr_reg_230;
...
assign m_axi_dst_ARLEN = mapchip_draw_xsize_read_reg_194;
...
assign sext_ln324_fu_168_p1 = $signed(trunc_ln324_3_fu_158_p4);

assign shl_ln324_2_fu_146_p3 = {{mul_i_i70_i_reg_225}, {2'd0}};

assign trunc_ln324_3_fu_158_p4 = {{add_ln324_fu_153_p2[63:2]}};

assign zext_ln78_fu_189_p1 = x_reg_122_pp0_iter1_reg;

endmodule //mapchip_dstin_loop_proc
