...
/* Definitions for driver MAPCHIP */
#define XPAR_XMAPCHIP_NUM_INSTANCES 1

/* Definitions for peripheral MAPCHIP_0 */
#define XPAR_MAPCHIP_0_DEVICE_ID 0
#define XPAR_MAPCHIP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_MAPCHIP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral MAPCHIP_0 */
#define XPAR_XMAPCHIP_0_DEVICE_ID XPAR_MAPCHIP_0_DEVICE_ID
#define XPAR_XMAPCHIP_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XMAPCHIP_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
