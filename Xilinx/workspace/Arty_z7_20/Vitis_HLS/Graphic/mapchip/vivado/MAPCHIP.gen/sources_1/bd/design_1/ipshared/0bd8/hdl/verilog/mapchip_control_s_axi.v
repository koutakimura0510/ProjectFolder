...
localparam
    ...
    ADDR_IER           = 6'h08,
    ADDR_ISR           = 6'h0c,
    ADDR_SRCIN_DATA_0  = 6'h10,
    ADDR_SRCIN_DATA_1  = 6'h14,
    ADDR_SRCIN_CTRL    = 6'h18,
    ADDR_DSTOUT_DATA_0 = 6'h1c,
    ADDR_DSTOUT_DATA_1 = 6'h20,
    ADDR_DSTOUT_CTRL   = 6'h24,
    ADDR_ALPHA_DATA_0  = 6'h28,
    ADDR_ALPHA_CTRL    = 6'h2c,
    WRIDLE             = 2'd0,
    WRDATA             = 2'd1,
    WRRESP             = 2'd2,
    WRRESET            = 2'd3,
