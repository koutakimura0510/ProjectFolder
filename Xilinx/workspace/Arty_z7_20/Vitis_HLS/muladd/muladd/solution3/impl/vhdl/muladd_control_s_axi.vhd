...
entity muladd_control_s_axi is
generic (
...
end entity muladd_control_s_axi;
...
architecture behave of muladd_control_s_axi is
    ...
    component muladd_control_s_axi_ram is
        generic (
            BYTES   : INTEGER :=4;
            DEPTH   : INTEGER :=256;
            AWIDTH  : INTEGER :=8);
    ...
    end component muladd_control_s_axi_ram;
...
-- ----------------------- Instantiation------------------
-- int_a
int_a : muladd_control_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 16,
     AWIDTH   => log2(16))
port map (
     ...
     q1       => int_a_q1);
-- int_b
int_b : muladd_control_s_axi_ram
generic map (
     BYTES    => 4,
     DEPTH    => 16,
     AWIDTH   => log2(16))
...
entity muladd_control_s_axi_ram is
    generic (
        BYTES   : INTEGER :=4;
        DEPTH   : INTEGER :=256;
        AWIDTH  : INTEGER :=8);
...
end entity muladd_control_s_axi_ram;

architecture behave of muladd_control_s_axi_ram is
