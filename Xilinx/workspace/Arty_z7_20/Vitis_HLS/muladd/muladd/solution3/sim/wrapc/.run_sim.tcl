...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "muladd.autotvin.dat"
	set constFileTvOut       "muladd.autotvout.dat"
	set constFileHdlTvIn     "muladd.autohdltvin.dat"
	set constFileHdlTvOut    "muladd.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
