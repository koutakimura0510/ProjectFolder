; ModuleID = '/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/LED/led_blink/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_led_blink_ir(%struct.ap_uint* %onoff, %struct.ap_uint.0* %led) local_unnamed_addr #0 {
entry:
  %onoff_copy1 = alloca %struct.ap_uint, align 512
  %led_copy2 = alloca %struct.ap_uint.0, align 512
  call fastcc void @copy_in(%struct.ap_uint* %onoff, %struct.ap_uint* nonnull align 512 %onoff_copy1, %struct.ap_uint.0* %led, %struct.ap_uint.0* nonnull align 512 %led_copy2)
  call void @apatb_led_blink_hw(%struct.ap_uint* %onoff_copy1, %struct.ap_uint.0* %led_copy2)
  call fastcc void @copy_out(%struct.ap_uint* %onoff, %struct.ap_uint* nonnull align 512 %onoff_copy1, %struct.ap_uint.0* %led, %struct.ap_uint.0* nonnull align 512 %led_copy2)
  ret void
}

; Function Attrs: noinline
define internal fastcc void @copy_in(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint.0*, %struct.ap_uint.0* noalias align 512) unnamed_addr #1 {
entry:
...
; Function Attrs: noinline
define internal fastcc void @copy_out(%struct.ap_uint*, %struct.ap_uint* noalias align 512, %struct.ap_uint.0*, %struct.ap_uint.0* noalias align 512) unnamed_addr #5 {
entry:
...
declare void @apatb_led_blink_hw(%struct.ap_uint*, %struct.ap_uint.0*)

define void @led_blink_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint.0*) #6 {
entry:
  call void @copy_out(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint.0* null, %struct.ap_uint.0* %1)
  call void @led_blink_hw_stub(%struct.ap_uint* %0, %struct.ap_uint.0* %1)
  call void @copy_in(%struct.ap_uint* null, %struct.ap_uint* %0, %struct.ap_uint.0* null, %struct.ap_uint.0* %1)
  ret void
}

declare void @led_blink_hw_stub(%struct.ap_uint*, %struct.ap_uint.0*)
