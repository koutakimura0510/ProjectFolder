...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/COUNT/CNT1/cnt_cmodA7.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnt_top.tcl
