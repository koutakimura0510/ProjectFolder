...
/* Definitions for driver SOUND_OPERATION */
#define XPAR_XSOUND_OPERATION_NUM_INSTANCES 1

/* Definitions for peripheral SOUND_OPERATION_0 */
#define XPAR_SOUND_OPERATION_0_DEVICE_ID 0
#define XPAR_SOUND_OPERATION_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_SOUND_OPERATION_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF


/******************************************************************/

/* Canonical definitions for peripheral SOUND_OPERATION_0 */
#define XPAR_XSOUND_OPERATION_0_DEVICE_ID XPAR_SOUND_OPERATION_0_DEVICE_ID
#define XPAR_XSOUND_OPERATION_0_S_AXI_CONTROL_BASEADDR 0x40000000
#define XPAR_XSOUND_OPERATION_0_S_AXI_CONTROL_HIGHADDR 0x4000FFFF
