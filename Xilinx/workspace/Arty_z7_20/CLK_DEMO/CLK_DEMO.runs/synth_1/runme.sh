...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xillinx/workspace/Arty_z7_20/CLK_DEMO/CLK_DEMO.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_demo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_demo.tcl
