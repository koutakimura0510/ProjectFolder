...
typedef enum
{
    ...
    TRY_MAP_MEMBER_EVENT_TYPE,
    TRY_MAP_MEMBER_NEXT_FILE_MAPDATA_ID,
    TRY_MAP_MEMBER_NEXT_FILE_OBJECT_ID,
    TRY_MAP_MEMBER_NEXT_FILE_REGION_ID,
    TRY_MAP_MEMBER_NEXT_FILE_NPC_ID,
    TRY_MAP_MEMBER_NEXT_FILE_MAPCHIP_ID,
    TRY_MAP_MEMBER_NEXT_FILE_BGM_ID,
    TRY_MAP_MEMBER_NEXT_MAP,
    TRY_MAP_MEMBER_NEXT_MAP_CANPASS_ID,
    TRY_MAP_MEMBER_NEXT_MAP_OBJECT_STARTID,
    TRY_MAP_MEMBER_NEXT_MAP_OBJECT_ENDID,
    TRY_MAP_MEMBER_UNITX,
    TRY_MAP_MEMBER_UNITY,
    TRY_MAP_MEMBER_FIELDX,
    TRY_MAP_MEMBER_FIELDY,
    TRY_MAP_MEMBER_ANIME_PIXELX,
    TRY_MAP_MEMBER_ANIME_PIXELY,
