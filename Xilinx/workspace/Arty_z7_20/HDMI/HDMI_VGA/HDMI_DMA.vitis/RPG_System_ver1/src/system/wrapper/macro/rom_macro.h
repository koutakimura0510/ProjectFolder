...
#define DRAM_BGM_MINIGAME_ADDR_BASE_START    (0x19000000)
...
#define DRAM_EFFECT_PITYUN_ADDR_BASE		(DRAM_EFFECT_BOMB_ADDR_BASE   + 0x00232800)		// 被弾エフェクト
...
/*
 * ミニゲームに使用する効果音の保存領域 上書き可能
 */
#define DRAM_BGM_MINIGAME_ADDR_BASE			(DRAM_BGM_MINIGAME_ADDR_BASE_START)
#define DRAM_BGM_COIN_ADDR_BASE			    (DRAM_BGM_MINIGAME_ADDR_BASE)			    // コイン取得
#define DRAM_BGM_JUMP_ADDR_BASE				(DRAM_BGM_COIN_ADDR_BASE    + 0x0002bc00)	// ジャンプ
#define DRAM_BGM_BOM_ADDR_BASE				(DRAM_BGM_JUMP_ADDR_BASE    + 0x0001b580)	// ボム使用
#define DRAM_BGM_PITYN_ADDR_BASE			(DRAM_BGM_BOM_ADDR_BASE     + 0x0009cbc0)	// 被弾時
