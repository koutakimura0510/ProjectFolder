...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/SW/SW_NOIZE/SW_NOIZE.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_NOIZE.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SW_NOIZE.tcl -notrace
