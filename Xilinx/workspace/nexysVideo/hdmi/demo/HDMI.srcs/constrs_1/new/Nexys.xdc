...
set_property -dict { PACKAGE_PIN U1    IOSTANDARD TMDS_33  } [get_ports { oHDMI_CLK_N }]; #IO_L1N_T0_34 Sch=hdmi_tx_clk_n
set_property -dict { PACKAGE_PIN T1    IOSTANDARD TMDS_33  } [get_ports { oHDMI_CLK_P }]; #IO_L1P_T0_34 Sch=hdmi_tx_clk_p
...
set_property -dict { PACKAGE_PIN Y1    IOSTANDARD TMDS_33  } [get_ports { oHDMI_N[0] }]; #IO_L5N_T0_34 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN W1    IOSTANDARD TMDS_33  } [get_ports { oHDMI_P[0] }]; #IO_L5P_T0_34 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN AB1   IOSTANDARD TMDS_33  } [get_ports { oHDMI_N[1] }]; #IO_L7N_T1_34 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN AA1   IOSTANDARD TMDS_33  } [get_ports { oHDMI_P[1] }]; #IO_L7P_T1_34 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN AB2   IOSTANDARD TMDS_33  } [get_ports { oHDMI_N[2] }]; #IO_L8N_T1_34 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN AB3   IOSTANDARD TMDS_33  } [get_ports { oHDMI_P[2] }]; #IO_L8P_T1_34 Sch=hdmi_tx_p[2]
