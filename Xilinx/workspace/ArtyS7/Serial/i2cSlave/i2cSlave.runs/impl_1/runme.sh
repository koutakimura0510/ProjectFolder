...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/Serial/i2cSlave/i2cSlave.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2cTop.tcl -notrace
