...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/SignalTraining/mSignal.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log signalTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source signalTop.tcl
