...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/Memory/rom/RomInit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log romTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source romTop.tcl -notrace
