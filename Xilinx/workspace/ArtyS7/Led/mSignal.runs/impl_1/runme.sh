...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/SignalTraining/mSignal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log signalTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source signalTop.tcl -notrace
