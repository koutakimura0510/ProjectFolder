...
HD_PWD='D:/workspace/Xilinx/workspace/CmodA7/BraveFrontierDemo/app.runs/synth_1_copy_1'
cd "$HD_PWD"
...
EAStep vivado -log BraveFrontier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BraveFrontier.tcl
