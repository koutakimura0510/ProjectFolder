...
HD_PWD='D:/workspace/Xilinx/workspace/CmodA7/SpiSlave/app.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SpiSlaveTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SpiSlaveTop.tcl
