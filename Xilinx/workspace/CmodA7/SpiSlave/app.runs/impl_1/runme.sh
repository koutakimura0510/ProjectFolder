...
HD_PWD='D:/workspace/Xilinx/workspace/CmodA7/SpiSlave/app.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SpiSlaveTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SpiSlaveTop.tcl -notrace
