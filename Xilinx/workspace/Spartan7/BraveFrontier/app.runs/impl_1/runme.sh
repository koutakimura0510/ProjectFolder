...
HD_PWD='D:/workspace/Xilinx/workspace/Spartan7/BraveFrontier/app.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log BraveFrontier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source BraveFrontier.tcl -notrace
