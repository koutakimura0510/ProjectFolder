...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/PWM/pwm_deep/PWM_DEEP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pwm_top.tcl -notrace
