...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xillinx/workspace/Arty_z7_20/CLK_DEMO/CLK_DEMO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_demo.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source clk_demo.tcl -notrace
