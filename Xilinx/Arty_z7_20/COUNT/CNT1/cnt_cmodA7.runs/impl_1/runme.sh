...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/COUNT/CNT1/cnt_cmodA7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cnt_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cnt_top.tcl -notrace
