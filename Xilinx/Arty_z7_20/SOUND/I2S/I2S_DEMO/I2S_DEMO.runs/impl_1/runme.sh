...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/SOUND/I2S/I2S_DEMO/I2S_DEMO.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log I2S_DEMO.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source I2S_DEMO.tcl -notrace
