...
__attribute__((sdx_kernel("led_blink", 0))) void led_blink(volatile ap_uint<1> *onoff, ap_uint<4> *led)
{
...
#pragma HLS INTERFACE m_axi port=onoff offset=slave bundle=onoff
# 4 "led_blink.cpp"

#pragma HLS INTERFACE s_axilite port=return
# 4 "led_blink.cpp"

#pragma HLS TOP name=led_blink
# 4 "led_blink.cpp"
