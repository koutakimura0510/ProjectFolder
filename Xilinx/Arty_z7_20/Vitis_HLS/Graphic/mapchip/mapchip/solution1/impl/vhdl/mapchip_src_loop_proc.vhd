...
entity mapchip_src_loop_proc is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
    ...
    src_V1_d0 : OUT STD_LOGIC_VECTOR (23 downto 0);
...
architecture behav of mapchip_src_loop_proc is 
...
attribute shreg_extract : string;
    ...
    signal icmp_ln878_reg_365 : STD_LOGIC_VECTOR (0 downto 0);
    ...
    signal mapchip_draw_xsize_read_reg_277 : STD_LOGIC_VECTOR (31 downto 0);
    signal id_read_reg_283 : STD_LOGIC_VECTOR (31 downto 0);
    signal mapchip_maxheight_read_reg_288 : STD_LOGIC_VECTOR (31 downto 0);
    signal ystart_pos_read_reg_293 : STD_LOGIC_VECTOR (31 downto 0);
    signal mapchip_maxwidth_read_reg_298 : STD_LOGIC_VECTOR (31 downto 0);
    signal xstart_pos_read_reg_304 : STD_LOGIC_VECTOR (31 downto 0);
    signal y_read_reg_309 : STD_LOGIC_VECTOR (31 downto 0);
    signal srcin_read_reg_314 : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_fu_188_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal mul_ln208_reg_319 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state3 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state3 : signal is "none";
    signal tmp_i_fu_192_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp_i_reg_324 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state4 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state4 : signal is "none";
    signal ap_CS_fsm_state5 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state5 : signal is "none";
    signal grp_fu_196_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal tmp6_i_reg_339 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_CS_fsm_state6 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state6 : signal is "none";
    signal grp_fu_206_p2 : STD_LOGIC_VECTOR (61 downto 0);
    signal mul_ln534_reg_344 : STD_LOGIC_VECTOR (61 downto 0);
    signal add_ln324_fu_220_p2 : STD_LOGIC_VECTOR (61 downto 0);
    signal add_ln324_reg_349 : STD_LOGIC_VECTOR (61 downto 0);
    signal ap_CS_fsm_state7 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state7 : signal is "none";
    signal src_addr_reg_354 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal add_ln73_fu_257_p2 : STD_LOGIC_VECTOR (31 downto 0);
    signal add_ln73_reg_360 : STD_LOGIC_VECTOR (31 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal icmp_ln878_fu_263_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal icmp_ln878_reg_365_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal trunc_ln324_fu_268_p1 : STD_LOGIC_VECTOR (23 downto 0);
    signal trunc_ln324_reg_369 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal zext_ln73_fu_272_p1 : STD_LOGIC_VECTOR (63 downto 0);
    ...
    signal trunc_ln324_2_fu_237_p4 : STD_LOGIC_VECTOR (61 downto 0);
    ...
    component mapchip_mul_32s_32s_32_2_1 IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    mul_32s_32s_32_2_1_U30 : component mapchip_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => id_read_reg_283,
        din1 => mapchip_maxheight_read_reg_288,
        ce => ap_const_logic_1,
        dout => grp_fu_188_p2);

    mul_32s_32s_32_2_1_U31 : component mapchip_mul_32s_32s_32_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    port map (
        clk => ap_clk,
        reset => ap_rst,
        din0 => mapchip_maxwidth_read_reg_298,
        din1 => tmp_i_reg_324,
        ce => ap_const_logic_1,
        dout => grp_fu_196_p2);

    mul_32ns_32ns_62_2_1_U32 : component mapchip_mul_32ns_32ns_62_2_1
    generic map (
        ID => 1,
        NUM_STAGE => 2,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            ...
            elsif (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
                x_reg_176 <= add_ln73_reg_360;
            end if; 
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state7)) then
                add_ln324_reg_349 <= add_ln324_fu_220_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                add_ln73_reg_360 <= add_ln73_fu_257_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                icmp_ln878_reg_365 <= icmp_ln878_fu_263_p2;
                icmp_ln878_reg_365_pp0_iter1_reg <= icmp_ln878_reg_365;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state1)) then
                id_read_reg_283 <= id_dout;
                mapchip_draw_xsize_read_reg_277 <= mapchip_draw_xsize_dout;
                mapchip_maxheight_read_reg_288 <= mapchip_maxheight_dout;
                mapchip_maxwidth_read_reg_298 <= mapchip_maxwidth_dout;
                srcin_read_reg_314 <= srcin_dout;
                xstart_pos_read_reg_304 <= xstart_pos_dout;
                y_read_reg_309 <= y_dout;
                ystart_pos_read_reg_293 <= ystart_pos_dout;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state3)) then
                mul_ln208_reg_319 <= grp_fu_188_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state6)) then
                mul_ln534_reg_344 <= grp_fu_206_p2;
                tmp6_i_reg_339 <= grp_fu_196_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_CS_fsm_state8)) then
                src_addr_reg_354 <= sext_ln324_fu_247_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                trunc_ln324_reg_369 <= trunc_ln324_fu_268_p1;
            end if;
        end if;
    end process;
    ...
    add_ln208_fu_212_p2 <= std_logic_vector(unsigned(xstart_pos_read_reg_304) + unsigned(tmp6_i_reg_339));
    add_ln324_1_fu_232_p2 <= std_logic_vector(unsigned(srcin_read_reg_314) + unsigned(shl_ln324_1_fu_225_p3));
    add_ln324_fu_220_p2 <= std_logic_vector(unsigned(mul_ln534_reg_344) + unsigned(zext_ln534_fu_216_p1));
    add_ln73_fu_257_p2 <= std_logic_vector(unsigned(ap_phi_mux_x_phi_fu_180_p4) + unsigned(ap_const_lv32_1));
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_src_RVALID, ap_enable_reg_pp0_iter1, icmp_ln878_reg_365)
    begin
                ap_block_pp0_stage0_11001 <= ((icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_src_RVALID = ap_const_logic_0));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_src_RVALID, ap_enable_reg_pp0_iter1, icmp_ln878_reg_365)
    begin
                ap_block_pp0_stage0_subdone <= ((icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (m_axi_src_RVALID = ap_const_logic_0));
    end process;
    ...
    ap_block_state17_pp0_stage0_iter1_assign_proc : process(m_axi_src_RVALID, icmp_ln878_reg_365)
    begin
                ap_block_state17_pp0_stage0_iter1 <= ((icmp_ln878_reg_365 = ap_const_lv1_0) and (m_axi_src_RVALID = ap_const_logic_0));
    end process;
    ...
    ap_phi_mux_x_phi_fu_180_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln878_reg_365, x_reg_176, add_ln73_reg_360)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
            ap_phi_mux_x_phi_fu_180_p4 <= add_ln73_reg_360;
        else 
    ...
    grp_fu_206_p00 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(y_read_reg_309),62));
    grp_fu_206_p1 <= grp_fu_206_p10(32 - 1 downto 0);
    grp_fu_206_p10 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(mapchip_maxwidth_read_reg_298),62));
    icmp_ln878_fu_263_p2 <= "1" when (ap_phi_mux_x_phi_fu_180_p4 = mapchip_draw_xsize_read_reg_277) else "0";
    ...
    m_axi_src_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, icmp_ln878_reg_365, ap_block_pp0_stage0_11001)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    begin
        ...
        sext_ln324_fu_247_p1 <= std_logic_vector(IEEE.numeric_std.resize(signed(trunc_ln324_2_fu_237_p4),64));

    shl_ln324_1_fu_225_p3 <= (add_ln324_reg_349 & ap_const_lv2_0);
    src_V1_address0 <= zext_ln73_fu_272_p1(10 - 1 downto 0);
    ...
    src_V1_d0 <= trunc_ln324_reg_369;

    src_V1_we0_assign_proc : process(ap_block_pp0_stage0_11001, icmp_ln878_reg_365_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (icmp_ln878_reg_365_pp0_iter1_reg = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    src_blk_n_R_assign_proc : process(m_axi_src_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, icmp_ln878_reg_365)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (icmp_ln878_reg_365 = ap_const_lv1_0) and (ap_const_boolean_0 = ap_block_pp0_stage0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1))) then 
    ...
    tmp_i_fu_192_p2 <= std_logic_vector(unsigned(ystart_pos_read_reg_293) + unsigned(mul_ln208_reg_319));
    trunc_ln324_2_fu_237_p4 <= add_ln324_1_fu_232_p2(63 downto 2);
    trunc_ln324_fu_268_p1 <= m_axi_src_RDATA(24 - 1 downto 0);
    ...
    zext_ln73_fu_272_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(x_reg_176_pp0_iter1_reg),64));
end behav;
