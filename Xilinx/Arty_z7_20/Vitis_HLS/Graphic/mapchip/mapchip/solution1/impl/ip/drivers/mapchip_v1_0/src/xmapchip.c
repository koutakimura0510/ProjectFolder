...
void XMapchip_Set_dstin(XMapchip *InstancePtr, u64 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_DSTIN_DATA, (u32)(Data));
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_DSTIN_DATA + 4, (u32)(Data >> 32));
}
...
u64 XMapchip_Get_dstin(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_DSTIN_DATA);
    Data += (u64)XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_DSTIN_DATA + 4) << 32;
    return Data;
}
...
void XMapchip_Set_mapchip_maxwidth(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_MAXWIDTH_DATA, Data);
}
...
u32 XMapchip_Get_mapchip_maxwidth(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_MAXWIDTH_DATA);
    return Data;
}
...
void XMapchip_Set_mapchip_maxheight(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_MAXHEIGHT_DATA, Data);
}
...
u32 XMapchip_Get_mapchip_maxheight(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_MAXHEIGHT_DATA);
    return Data;
}
...
void XMapchip_Set_mapchip_draw_xsize(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_DRAW_XSIZE_DATA, Data);
}
...
u32 XMapchip_Get_mapchip_draw_xsize(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_DRAW_XSIZE_DATA);
    return Data;
}
...
void XMapchip_Set_mapchip_draw_ysize(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_DRAW_YSIZE_DATA, Data);
}
...
u32 XMapchip_Get_mapchip_draw_ysize(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_MAPCHIP_DRAW_YSIZE_DATA);
    return Data;
}
...
void XMapchip_Set_xstart_pos(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_XSTART_POS_DATA, Data);
}
...
u32 XMapchip_Get_xstart_pos(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_XSTART_POS_DATA);
    return Data;
}
...
void XMapchip_Set_ystart_pos(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_YSTART_POS_DATA, Data);
}
...
u32 XMapchip_Get_ystart_pos(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_YSTART_POS_DATA);
    return Data;
}
...
void XMapchip_Set_frame_size(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_FRAME_SIZE_DATA, Data);
}
...
u32 XMapchip_Get_frame_size(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_FRAME_SIZE_DATA);
    return Data;
}
...
void XMapchip_Set_id(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_ID_DATA, Data);
}
...
u32 XMapchip_Get_id(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_ID_DATA);
    return Data;
}
...
void XMapchip_Set_crip(XMapchip *InstancePtr, u32 Data) {
    ...
    XMapchip_WriteReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_CRIP_DATA, Data);
}
...
u32 XMapchip_Get_crip(XMapchip *InstancePtr) {
    ...
    Data = XMapchip_ReadReg(InstancePtr->Control_BaseAddress, XMAPCHIP_CONTROL_ADDR_CRIP_DATA);
    return Data;
}
