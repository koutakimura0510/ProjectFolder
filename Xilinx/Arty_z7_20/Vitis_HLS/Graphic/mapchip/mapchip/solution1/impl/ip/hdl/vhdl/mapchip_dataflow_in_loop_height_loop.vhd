...
entity mapchip_dataflow_in_loop_height_loop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of mapchip_dataflow_in_loop_height_loop is 
...
attribute shreg_extract : string;
    signal src_V_i_q0 : STD_LOGIC_VECTOR (23 downto 0);
    signal src_V_t_q0 : STD_LOGIC_VECTOR (23 downto 0);
    signal dst_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal dst_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dataflow_in_loop_height_loop_entry6_U0_crip_out_din : STD_LOGIC_VECTOR (23 downto 0);
    signal dataflow_in_loop_height_loop_entry6_U0_crip_out_write : STD_LOGIC;
    ...
    signal src_loop_proc_U0_src_V1_d0 : STD_LOGIC_VECTOR (23 downto 0);
    ...
    signal dstin_loop_proc_U0_dst_V2_d0 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal dstout_loop_proc_U0_crip_read : STD_LOGIC;
    ...
    signal crip_c_full_n : STD_LOGIC;
    signal crip_c_dout : STD_LOGIC_VECTOR (23 downto 0);
    signal crip_c_empty_n : STD_LOGIC;
    ...
    component mapchip_dataflow_in_loop_height_loop_entry6 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mapchip_src_loop_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mapchip_dstin_loop_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mapchip_dstout_loop_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component mapchip_dataflow_in_loop_height_loop_src_V IS
    generic (
        DataWidth : INTEGER;
    ...
    component mapchip_dataflow_in_loop_height_loop_dst_V IS
    generic (
        DataWidth : INTEGER;
        AddressRange : INTEGER;
        AddressWidth : INTEGER );
    ...
    component mapchip_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component mapchip_fifo_w64_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component mapchip_fifo_w32_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component mapchip_fifo_w64_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component mapchip_fifo_w24_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component mapchip_fifo_w8_d3_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    src_V_U : component mapchip_dataflow_in_loop_height_loop_src_V
    generic map (
        DataWidth => 24,
        AddressRange => 640,
        AddressWidth => 10)
    ...
    dst_V_U : component mapchip_dataflow_in_loop_height_loop_dst_V
    generic map (
        DataWidth => 32,
        AddressRange => 640,
        AddressWidth => 10)
    ...
    dataflow_in_loop_height_loop_entry6_U0 : component mapchip_dataflow_in_loop_height_loop_entry6
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        crip_out_din => dataflow_in_loop_height_loop_entry6_U0_crip_out_din,
        crip_out_full_n => crip_c_full_n,
        crip_out_write => dataflow_in_loop_height_loop_entry6_U0_crip_out_write,
    ...
    src_loop_proc_U0 : component mapchip_src_loop_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dstin_loop_proc_U0 : component mapchip_dstin_loop_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    dstout_loop_proc_U0 : component mapchip_dstout_loop_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        crip_dout => crip_c_dout,
        crip_empty_n => crip_c_empty_n,
        crip_read => dstout_loop_proc_U0_crip_read,
        alpha_dout => alpha_c_dout,
        alpha_empty_n => alpha_c_empty_n,
        alpha_read => dstout_loop_proc_U0_alpha_read);

    mapchip_draw_xsize_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    mapchip_draw_xsize_c1_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    id_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    mapchip_maxheight_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ystart_pos_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    mapchip_maxwidth_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    xstart_pos_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    y_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    y_c2_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    srcin_c_U : component mapchip_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    frame_size_c_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    frame_size_c3_U : component mapchip_fifo_w32_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    dstin_c_U : component mapchip_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    dstout_c_U : component mapchip_fifo_w64_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    crip_c_U : component mapchip_fifo_w24_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
        if_write_ce => ap_const_logic_1,
        if_din => dataflow_in_loop_height_loop_entry6_U0_crip_out_din,
        if_full_n => crip_c_full_n,
        if_write => dataflow_in_loop_height_loop_entry6_U0_crip_out_write,
        if_dout => crip_c_dout,
        if_empty_n => crip_c_empty_n,
        if_read => dstout_loop_proc_U0_crip_read);

    alpha_c_U : component mapchip_fifo_w8_d3_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    mapchip_draw_xsize_c4_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    y_c5_U : component mapchip_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
