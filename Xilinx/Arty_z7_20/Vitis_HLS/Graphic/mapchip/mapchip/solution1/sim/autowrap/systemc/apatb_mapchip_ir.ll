...
define void @apatb_mapchip_ir(%struct.ap_uint* %srcin, %struct.ap_uint* %dstin, %struct.ap_uint* %dstout, %struct.ap_uint.0* nocapture readonly %alpha) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_mapchip_hw(%struct.ap_uint* %3, %struct.ap_uint* %4, %struct.ap_uint* %5, %struct.ap_uint.0* %alpha)
...
declare void @apatb_mapchip_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*)

define void @mapchip_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*) #6 {
entry:
  %4 = bitcast %struct.ap_uint* %0 to [307200 x %struct.ap_uint]*
  %5 = bitcast %struct.ap_uint* %1 to [307200 x %struct.ap_uint]*
  %6 = bitcast %struct.ap_uint* %2 to [307200 x %struct.ap_uint]*
  call void @copy_out([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %4, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %5, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6)
  %7 = bitcast [307200 x %struct.ap_uint]* %4 to %struct.ap_uint*
  %8 = bitcast [307200 x %struct.ap_uint]* %5 to %struct.ap_uint*
  %9 = bitcast [307200 x %struct.ap_uint]* %6 to %struct.ap_uint*
  call void @mapchip_hw_stub(%struct.ap_uint* %7, %struct.ap_uint* %8, %struct.ap_uint* %9, %struct.ap_uint.0* %3)
  call void @copy_in([307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %4, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %5, [307200 x %struct.ap_uint]* null, [307200 x %struct.ap_uint]* %6)
  ret void
}

declare void @mapchip_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint.0*)
