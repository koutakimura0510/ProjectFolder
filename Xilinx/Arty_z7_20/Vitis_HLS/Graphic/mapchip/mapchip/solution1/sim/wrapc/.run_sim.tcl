...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mapchip.autotvin.dat"
	set constFileTvOut       "mapchip.autotvout.dat"
	set constFileHdlTvIn     "mapchip.autohdltvin.dat"
	set constFileHdlTvOut    "mapchip.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
