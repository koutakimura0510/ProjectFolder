...
set id 55
set name mapchip_mul_8ns_8ns_16_1_1
...
set id 58
set name mapchip_mac_muladd_8ns_8ns_16ns_17_4_1
...
set id 61
set name mapchip_mul_mul_17ns_19ns_35_4_1
set corename simcore_mul
set op mul
set stage_num 4
set max_latency -1
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename src_V1 \
    op interface \
    ports { src_V1_address0 { O 10 vector } src_V1_ce0 { O 1 bit } src_V1_q0 { I 24 vector } } \
} "
} else {
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename dst_V2 \
    op interface \
    ports { dst_V2_address0 { O 10 vector } dst_V2_ce0 { O 1 bit } dst_V2_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_crip \
    op interface \
    ports { crip_dout { I 24 vector } crip_empty_n { I 1 bit } crip_read { O 1 bit } } \
} "
}
