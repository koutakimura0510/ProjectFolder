...
entity mapchip_color_control_s_axi is
generic (
...
end entity mapchip_color_control_s_axi;
...
architecture behave of mapchip_color_control_s_axi is
    ...
    constant ADDR_FILL_DATA_0               : INTEGER := 16#74#;
    constant ADDR_FILL_CTRL                 : INTEGER := 16#78#;
    constant ADDR_COM_DATA_0                : INTEGER := 16#7c#;
    constant ADDR_COM_CTRL                  : INTEGER := 16#80#;
    constant ADDR_ID_DATA_0                 : INTEGER := 16#84#;
    constant ADDR_ID_CTRL                   : INTEGER := 16#88#;
    ...
    signal int_fill            : UNSIGNED(31 downto 0) := (others => '0');
    signal int_com             : UNSIGNED(31 downto 0) := (others => '0');
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_FILL_DATA_0 =>
                        rdata_data <= RESIZE(int_fill(31 downto 0), 32);
                    when ADDR_COM_DATA_0 =>
                        rdata_data <= RESIZE(int_com(31 downto 0), 32);
                    when ADDR_ID_DATA_0 =>
...
-- ----------------------- Register logic ----------------
    ...
    fill                 <= STD_LOGIC_VECTOR(int_fill);
    com                  <= STD_LOGIC_VECTOR(int_com);
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_FILL_DATA_0) then
                    int_fill(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_fill(31 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_COM_DATA_0) then
                    int_com(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_com(31 downto 0));
                end if;
            end if;
        end if;
    end process;
