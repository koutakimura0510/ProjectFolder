...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename copy_V1 \
    op interface \
    ports { copy_V1_address0 { O 10 vector } copy_V1_ce0 { O 1 bit } copy_V1_q0 { I 32 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_xend \
    op interface \
    ports { xend_dout { I 32 vector } xend_empty_n { I 1 bit } xend_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_y_2 \
    op interface \
    ports { y_2_dout { I 32 vector } y_2_empty_n { I 1 bit } y_2_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_yend \
    op interface \
    ports { yend_dout { I 32 vector } yend_empty_n { I 1 bit } yend_read { O 1 bit } } \
} "
}
