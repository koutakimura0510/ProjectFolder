set moduleName dataflow_in_loop_right_height_loop
set isTopModule 0
...
set C_modelName {dataflow_in_loop_right_height_loop}
...
set portList { 
	...
	{ y_1_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y_1_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "y_1", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "2", "4", "6", "7", "8", "9"],
		...
		"InputProcess" : [
			{"ID" : "2", "Name" : "right_width_loop_proc8_U0"}],
		"OutputProcess" : [
			{"ID" : "4", "Name" : "right_copy_loop_proc_U0"}],
		"Port" : [
			...
			{"Name" : "copy", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "right_width_loop_proc8_U0", "Port" : "copy"}]},
			{"Name" : "ddr_update", "Type" : "None", "Direction" : "I"},
			{"Name" : "update", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "4", "SubInstance" : "right_copy_loop_proc_U0", "Port" : "update"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.xcopy_V_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.right_width_loop_proc8_U0", "Parent" : "0", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "xcopy_V1", "Type" : "Memory", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "1"},
			{"Name" : "ddr_update", "Type" : "None", "Direction" : "I"},
			...
			{"Name" : "y_1_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "7", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "ddr_update_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "4", "DependentChan" : "9", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "ddr_update_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "3", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.right_width_loop_proc8_U0.mul_32ns_32ns_62_2_1_U21", "Parent" : "2"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.right_copy_loop_proc_U0", "Parent" : "0", "Child" : ["5"],
		...
		"Port" : [
			...
			{"Name" : "y_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "7", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "xcopy_V1", "Type" : "Memory", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "1"},
			{"Name" : "ddr_update", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "2", "DependentChan" : "9", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.right_copy_loop_proc_U0.mul_32ns_32ns_62_2_1_U33", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.width_c_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.y_1_c_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.frame_size_c_U", "Parent" : "0"},
	{"ID" : "9", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.ddr_update_c_U", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	y_1 { ap_none {  { y_1 in_data 0 32 }  { y_1_ap_vld in_vld 0 1 } } }
