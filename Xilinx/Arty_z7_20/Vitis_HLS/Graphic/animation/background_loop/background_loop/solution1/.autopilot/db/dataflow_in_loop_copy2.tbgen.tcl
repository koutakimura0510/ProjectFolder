set moduleName dataflow_in_loop_copy2
set isTopModule 0
...
set C_modelName {dataflow_in_loop_copy2}
set C_modelType { void 0 }
set C_modelArgList {
	{ ycopy_V int 32 regular {array 640 { 1 3 } 1 1 }  }
	{ trunc_ln329 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "ycopy_V", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "trunc_ln329", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portNum 68
set portList { 
	{ ycopy_V_address0 sc_out sc_lv 10 signal 0 } 
	{ ycopy_V_ce0 sc_out sc_logic 1 signal 0 } 
	{ ycopy_V_d0 sc_out sc_lv 32 signal 0 } 
	{ ycopy_V_q0 sc_in sc_lv 32 signal 0 } 
	{ ycopy_V_we0 sc_out sc_logic 1 signal 0 } 
	{ ycopy_V_address1 sc_out sc_lv 10 signal 0 } 
	{ ycopy_V_ce1 sc_out sc_logic 1 signal 0 } 
	{ ycopy_V_d1 sc_out sc_lv 32 signal 0 } 
	{ ycopy_V_q1 sc_in sc_lv 32 signal 0 } 
	{ ycopy_V_we1 sc_out sc_logic 1 signal 0 } 
	{ trunc_ln329 sc_in sc_lv 32 signal 1 } 
	...
	{ trunc_ln329_ap_vld sc_in sc_logic 1 invld 1 } 
...
set NewPortList {[ 
	{ "name": "ycopy_V_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "ycopy_V", "role": "address0" }} , 
 	...
 	{ "name": "trunc_ln329", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "trunc_ln329", "role": "default" }} , 
 	...
 	{ "name": "trunc_ln329_ap_vld", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "invld", "bundle":{"name": "trunc_ln329", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "Block_entry_proc_proc7_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "Block_entry_proc_proc7_U0"}],
		"Port" : [
			{"Name" : "ycopy_V", "Type" : "Memory", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "Block_entry_proc_proc7_U0", "Port" : "ycopy_V"}]},
			{"Name" : "trunc_ln329", "Type" : "None", "Direction" : "I"},
			{"Name" : "update", "Type" : "MAXI", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "Block_entry_proc_proc7_U0", "Port" : "update"}]},
			{"Name" : "frame_size", "Type" : "None", "Direction" : "I"},
			{"Name" : "ddr_update", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.Block_entry_proc_proc7_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "frame_size", "Type" : "None", "Direction" : "I"},
			{"Name" : "ddr_update", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.Block_entry_proc_proc7_U0.mul_32ns_32ns_62_2_1_U59", "Parent" : "1"}]}
...
set Spec2ImplPortList { 
	...
	trunc_ln329 { ap_none {  { trunc_ln329 in_data 0 32 }  { trunc_ln329_ap_vld in_vld 0 1 } } }
