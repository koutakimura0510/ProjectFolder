...
entity background_loop_dataflow_in_loop_right_height_loop is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of background_loop_dataflow_in_loop_right_height_loop is 
...
attribute shreg_extract : string;
    signal xcopy_V_i_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal xcopy_V_t_q0 : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_ap_start : STD_LOGIC;
    signal right_width_loop_proc8_U0_ap_done : STD_LOGIC;
    signal right_width_loop_proc8_U0_ap_continue : STD_LOGIC;
    signal right_width_loop_proc8_U0_ap_idle : STD_LOGIC;
    signal right_width_loop_proc8_U0_ap_ready : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_AWVALID : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_WVALID : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_WLAST : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARVALID : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_width_loop_proc8_U0_m_axi_copy_RREADY : STD_LOGIC;
    signal right_width_loop_proc8_U0_m_axi_copy_BREADY : STD_LOGIC;
    signal right_width_loop_proc8_U0_xcopy_V1_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal right_width_loop_proc8_U0_xcopy_V1_ce0 : STD_LOGIC;
    signal right_width_loop_proc8_U0_xcopy_V1_we0 : STD_LOGIC;
    signal right_width_loop_proc8_U0_xcopy_V1_d0 : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_width_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_width_out_write : STD_LOGIC;
    signal right_width_loop_proc8_U0_y_1_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_y_1_out_write : STD_LOGIC;
    signal right_width_loop_proc8_U0_frame_size_out_din : STD_LOGIC_VECTOR (31 downto 0);
    signal right_width_loop_proc8_U0_frame_size_out_write : STD_LOGIC;
    signal right_width_loop_proc8_U0_ddr_update_out_din : STD_LOGIC_VECTOR (63 downto 0);
    signal right_width_loop_proc8_U0_ddr_update_out_write : STD_LOGIC;
    signal ap_channel_done_xcopy_V : STD_LOGIC;
    signal right_width_loop_proc8_U0_xcopy_V1_full_n : STD_LOGIC;
    signal right_copy_loop_proc_U0_ap_start : STD_LOGIC;
    signal right_copy_loop_proc_U0_ap_done : STD_LOGIC;
    signal right_copy_loop_proc_U0_ap_continue : STD_LOGIC;
    signal right_copy_loop_proc_U0_ap_idle : STD_LOGIC;
    signal right_copy_loop_proc_U0_ap_ready : STD_LOGIC;
    signal right_copy_loop_proc_U0_width_read : STD_LOGIC;
    signal right_copy_loop_proc_U0_y_1_read : STD_LOGIC;
    signal right_copy_loop_proc_U0_frame_size_read : STD_LOGIC;
    signal right_copy_loop_proc_U0_xcopy_V1_address0 : STD_LOGIC_VECTOR (9 downto 0);
    signal right_copy_loop_proc_U0_xcopy_V1_ce0 : STD_LOGIC;
    signal right_copy_loop_proc_U0_ddr_update_read : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_AWVALID : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_AWADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_WVALID : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_WDATA : STD_LOGIC_VECTOR (31 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_WSTRB : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_WLAST : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARVALID : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_ARADDR : STD_LOGIC_VECTOR (63 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal right_copy_loop_proc_U0_m_axi_update_RREADY : STD_LOGIC;
    signal right_copy_loop_proc_U0_m_axi_update_BREADY : STD_LOGIC;
    signal ap_sync_continue : STD_LOGIC;
    signal xcopy_V_i_full_n : STD_LOGIC;
    signal xcopy_V_t_empty_n : STD_LOGIC;
    signal width_c_full_n : STD_LOGIC;
    signal width_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal width_c_empty_n : STD_LOGIC;
    signal y_1_c_full_n : STD_LOGIC;
    signal y_1_c_dout : STD_LOGIC_VECTOR (31 downto 0);
    signal y_1_c_empty_n : STD_LOGIC;
    ...
    signal right_width_loop_proc8_U0_start_full_n : STD_LOGIC;
    signal right_width_loop_proc8_U0_start_write : STD_LOGIC;
    signal right_copy_loop_proc_U0_start_full_n : STD_LOGIC;
    signal right_copy_loop_proc_U0_start_write : STD_LOGIC;

    component background_loop_right_width_loop_proc8 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component background_loop_right_copy_loop_proc IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component background_loop_dataflow_in_loop_right_height_loop_xcopy_V IS
    generic (
        DataWidth : INTEGER;
    ...
    component background_loop_fifo_w32_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
    ...
    component background_loop_fifo_w64_d2_S IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    xcopy_V_U : component background_loop_dataflow_in_loop_right_height_loop_xcopy_V
    generic map (
        DataWidth => 32,
        AddressRange => 640,
        AddressWidth => 10)
    ...
    right_width_loop_proc8_U0 : component background_loop_right_width_loop_proc8
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    right_copy_loop_proc_U0 : component background_loop_right_copy_loop_proc
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    width_c_U : component background_loop_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    y_1_c_U : component background_loop_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    frame_size_c_U : component background_loop_fifo_w32_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ddr_update_c_U : component background_loop_fifo_w64_d2_S
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ap_channel_done_xcopy_V <= right_width_loop_proc8_U0_ap_done;
    ap_done <= right_copy_loop_proc_U0_ap_done;
    ap_idle <= (right_width_loop_proc8_U0_ap_idle and right_copy_loop_proc_U0_ap_idle and (xcopy_V_t_empty_n xor ap_const_logic_1));
    ap_ready <= right_width_loop_proc8_U0_ap_ready;
    ap_sync_continue <= ap_continue;
    ap_sync_done <= right_copy_loop_proc_U0_ap_done;
    ap_sync_ready <= right_width_loop_proc8_U0_ap_ready;
    m_axi_copy_ARADDR <= right_width_loop_proc8_U0_m_axi_copy_ARADDR;
    m_axi_copy_ARBURST <= right_width_loop_proc8_U0_m_axi_copy_ARBURST;
    m_axi_copy_ARCACHE <= right_width_loop_proc8_U0_m_axi_copy_ARCACHE;
    m_axi_copy_ARID <= right_width_loop_proc8_U0_m_axi_copy_ARID;
    ...
    m_axi_update_WUSER <= right_copy_loop_proc_U0_m_axi_update_WUSER;
    m_axi_update_WVALID <= right_copy_loop_proc_U0_m_axi_update_WVALID;
    right_copy_loop_proc_U0_ap_continue <= ap_continue;
    right_copy_loop_proc_U0_ap_start <= xcopy_V_t_empty_n;
    right_copy_loop_proc_U0_start_full_n <= ap_const_logic_1;
    right_copy_loop_proc_U0_start_write <= ap_const_logic_0;
    right_width_loop_proc8_U0_ap_continue <= xcopy_V_i_full_n;
    right_width_loop_proc8_U0_ap_start <= ap_start;
    right_width_loop_proc8_U0_start_full_n <= ap_const_logic_1;
    right_width_loop_proc8_U0_start_write <= ap_const_logic_0;
    right_width_loop_proc8_U0_xcopy_V1_full_n <= xcopy_V_i_full_n;
end behav;
