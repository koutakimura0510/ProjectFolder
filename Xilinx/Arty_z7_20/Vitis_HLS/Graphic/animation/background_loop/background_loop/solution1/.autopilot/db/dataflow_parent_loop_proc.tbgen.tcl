...
set portList { 
	...
	{ m_axi_copy_AWVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_AWREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_AWADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_copy_AWID sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_AWLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_copy_AWSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_copy_AWBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_copy_AWLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_copy_AWCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_AWPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_copy_AWQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_AWREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_AWUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_WVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_WREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_WDATA sc_out sc_lv 32 signal 1 } 
	{ m_axi_copy_WSTRB sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_WLAST sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_WID sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_WUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_ARVALID sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_ARREADY sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_ARADDR sc_out sc_lv 64 signal 1 } 
	{ m_axi_copy_ARID sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_ARLEN sc_out sc_lv 32 signal 1 } 
	{ m_axi_copy_ARSIZE sc_out sc_lv 3 signal 1 } 
	{ m_axi_copy_ARBURST sc_out sc_lv 2 signal 1 } 
	{ m_axi_copy_ARLOCK sc_out sc_lv 2 signal 1 } 
	{ m_axi_copy_ARCACHE sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_ARPROT sc_out sc_lv 3 signal 1 } 
	{ m_axi_copy_ARQOS sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_ARREGION sc_out sc_lv 4 signal 1 } 
	{ m_axi_copy_ARUSER sc_out sc_lv 1 signal 1 } 
	{ m_axi_copy_RVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_RREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_RDATA sc_in sc_lv 32 signal 1 } 
	{ m_axi_copy_RLAST sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_RID sc_in sc_lv 1 signal 1 } 
	{ m_axi_copy_RUSER sc_in sc_lv 1 signal 1 } 
	{ m_axi_copy_RRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_copy_BVALID sc_in sc_logic 1 signal 1 } 
	{ m_axi_copy_BREADY sc_out sc_logic 1 signal 1 } 
	{ m_axi_copy_BRESP sc_in sc_lv 2 signal 1 } 
	{ m_axi_copy_BID sc_in sc_lv 1 signal 1 } 
	{ m_axi_copy_BUSER sc_in sc_lv 1 signal 1 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"InputProcess" : [
			{"ID" : "1", "Name" : "dataflow_in_loop_copy_U0"}],
		"OutputProcess" : [
			{"ID" : "1", "Name" : "dataflow_in_loop_copy_U0"}],
		"Port" : [
			...
			{"Name" : "copy", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_in_loop_copy_U0", "Port" : "copy"}]},
			{"Name" : "frame_size", "Type" : "None", "Direction" : "I"},
			{"Name" : "width", "Type" : "None", "Direction" : "I"},
			{"Name" : "ddr_copy", "Type" : "None", "Direction" : "I"},
			{"Name" : "ycopy_V", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "1", "SubInstance" : "dataflow_in_loop_copy_U0", "Port" : "ycopy_V"}]}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_copy_U0", "Parent" : "0", "Child" : ["2"],
		...
		"HasNonBlockingOperation" : "0",
		"InputProcess" : [
			{"ID" : "2", "Name" : "Block_entry_proc_proc_U0"}],
		"OutputProcess" : [
			{"ID" : "2", "Name" : "Block_entry_proc_proc_U0"}],
		"Port" : [
			{"Name" : "copy", "Type" : "MAXI", "Direction" : "I",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Block_entry_proc_proc_U0", "Port" : "copy"}]},
			...
			{"Name" : "ycopy_V", "Type" : "Memory", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "2", "SubInstance" : "Block_entry_proc_proc_U0", "Port" : "ycopy_V"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_copy_U0.Block_entry_proc_proc_U0", "Parent" : "1", "Child" : ["3"],
		...
		"Port" : [
			...
			{"Name" : "ddr_copy", "Type" : "None", "Direction" : "I"},
			{"Name" : "ycopy_V", "Type" : "Memory", "Direction" : "O"}]},
	{"ID" : "3", "Level" : "3", "Path" : "`AUTOTB_DUT_INST.dataflow_in_loop_copy_U0.Block_entry_proc_proc_U0.mul_32ns_32ns_62_2_1_U1", "Parent" : "2"}]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "14", "Max" : "5762"}
	, {"Name" : "Interval", "Min" : "14", "Max" : "5762"}
]}
