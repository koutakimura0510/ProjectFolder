set moduleName right_copy_loop_proc
set isTopModule 0
...
set C_modelName {right_copy_loop_proc}
set C_modelType { void 0 }
set C_modelArgList {
	{ width int 32 regular {fifo 0}  }
	{ y_1 int 32 regular {fifo 0}  }
	{ frame_size int 32 regular {fifo 0}  }
	{ xcopy_V1 int 32 regular {array 640 { 1 3 } 1 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "width", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "y_1", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "frame_size", "interface" : "fifo", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "xcopy_V1", "interface" : "memory", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ y_1_dout sc_in sc_lv 32 signal 1 } 
	{ y_1_empty_n sc_in sc_logic 1 signal 1 } 
	{ y_1_read sc_out sc_logic 1 signal 1 } 
	...
	{ xcopy_V1_address0 sc_out sc_lv 10 signal 3 } 
	{ xcopy_V1_ce0 sc_out sc_logic 1 signal 3 } 
	{ xcopy_V1_q0 sc_in sc_lv 32 signal 3 } 
	{ ddr_update_dout sc_in sc_lv 64 signal 4 } 
	{ ddr_update_empty_n sc_in sc_logic 1 signal 4 } 
	{ ddr_update_read sc_out sc_logic 1 signal 4 } 
	{ m_axi_update_AWVALID sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_AWREADY sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_AWADDR sc_out sc_lv 64 signal 5 } 
	{ m_axi_update_AWID sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_AWLEN sc_out sc_lv 32 signal 5 } 
	{ m_axi_update_AWSIZE sc_out sc_lv 3 signal 5 } 
	{ m_axi_update_AWBURST sc_out sc_lv 2 signal 5 } 
	{ m_axi_update_AWLOCK sc_out sc_lv 2 signal 5 } 
	{ m_axi_update_AWCACHE sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_AWPROT sc_out sc_lv 3 signal 5 } 
	{ m_axi_update_AWQOS sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_AWREGION sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_AWUSER sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_WVALID sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_WREADY sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_WDATA sc_out sc_lv 32 signal 5 } 
	{ m_axi_update_WSTRB sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_WLAST sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_WID sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_WUSER sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_ARVALID sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_ARREADY sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_ARADDR sc_out sc_lv 64 signal 5 } 
	{ m_axi_update_ARID sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_ARLEN sc_out sc_lv 32 signal 5 } 
	{ m_axi_update_ARSIZE sc_out sc_lv 3 signal 5 } 
	{ m_axi_update_ARBURST sc_out sc_lv 2 signal 5 } 
	{ m_axi_update_ARLOCK sc_out sc_lv 2 signal 5 } 
	{ m_axi_update_ARCACHE sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_ARPROT sc_out sc_lv 3 signal 5 } 
	{ m_axi_update_ARQOS sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_ARREGION sc_out sc_lv 4 signal 5 } 
	{ m_axi_update_ARUSER sc_out sc_lv 1 signal 5 } 
	{ m_axi_update_RVALID sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_RREADY sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_RDATA sc_in sc_lv 32 signal 5 } 
	{ m_axi_update_RLAST sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_RID sc_in sc_lv 1 signal 5 } 
	{ m_axi_update_RUSER sc_in sc_lv 1 signal 5 } 
	{ m_axi_update_RRESP sc_in sc_lv 2 signal 5 } 
	{ m_axi_update_BVALID sc_in sc_logic 1 signal 5 } 
	{ m_axi_update_BREADY sc_out sc_logic 1 signal 5 } 
	{ m_axi_update_BRESP sc_in sc_lv 2 signal 5 } 
	{ m_axi_update_BID sc_in sc_lv 1 signal 5 } 
	{ m_axi_update_BUSER sc_in sc_lv 1 signal 5 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "y_1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "y_1", "role": "dout" }} , 
 	{ "name": "y_1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "y_1", "role": "empty_n" }} , 
 	{ "name": "y_1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "y_1", "role": "read" }} , 
 	...
 	{ "name": "xcopy_V1_q0", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "xcopy_V1", "role": "q0" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "y_1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
			...
			{"Name" : "xcopy_V1", "Type" : "Memory", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0"},
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_32ns_32ns_62_2_1_U33", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	...
	y_1 { ap_fifo {  { y_1_dout fifo_data 0 32 }  { y_1_empty_n fifo_status 0 1 }  { y_1_read fifo_update 1 1 } } }
	frame_size { ap_fifo {  { frame_size_dout fifo_data 0 32 }  { frame_size_empty_n fifo_status 0 1 }  { frame_size_read fifo_update 1 1 } } }
	xcopy_V1 { ap_memory {  { xcopy_V1_address0 mem_address 1 10 }  { xcopy_V1_ce0 mem_ce 1 1 }  { xcopy_V1_q0 mem_dout 0 32 } } }
