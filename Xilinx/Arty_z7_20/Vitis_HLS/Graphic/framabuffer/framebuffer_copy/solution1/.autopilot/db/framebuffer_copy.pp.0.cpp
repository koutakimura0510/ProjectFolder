...
# 2 "framebuffer_copy.cpp" 2



typedef ap_uint<32> u32;

__attribute__((sdx_kernel("framebuffer_copy", 0))) void framebuffer_copy(
    volatile u32 *copy,
    volatile u32 *update,
    u32 width,
    u32 height,
...
{
#pragma HLS INTERFACE m_axi depth=399360 port=copy offset=slave bundle=cp num_read_outstanding=16 max_read_burst_length=32
# 14 "framebuffer_copy.cpp"

#pragma HLS INTERFACE m_axi depth=399360 port=update offset=slave bundle=up num_write_outstanding=16 max_write_burst_length=32
# 14 "framebuffer_copy.cpp"

#pragma HLS INTERFACE s_axilite port=display_xsize
# 14 "framebuffer_copy.cpp"
...
#pragma HLS TOP name=framebuffer_copy
# 14 "framebuffer_copy.cpp"
    ...
    {
#pragma HLS DATAFLOW
# 18 "framebuffer_copy.cpp"

#pragma HLS LOOP_TRIPCOUNT min=1 max=480 avg=480
# 18 "framebuffer_copy.cpp"

        width_loop:for (int x = 0; x < width; x++)
        {
#pragma HLS LOOP_TRIPCOUNT min=1 max=640 avg=128
# 20 "framebuffer_copy.cpp"
