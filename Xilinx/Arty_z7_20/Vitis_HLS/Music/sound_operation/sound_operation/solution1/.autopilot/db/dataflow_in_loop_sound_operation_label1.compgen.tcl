...
# FIFO definition:
set ID 9
set FifoName sound_operation_fifo_w64_d2_S
set InstName ramadr_c1_U
...
# FIFO definition:
set ID 11
set FifoName sound_operation_start_for_dataflow_in_loop_sound_operation_label1_entry4_U0
set InstName start_for_dataflow_in_loop_sound_operation_label1_entry4_U0_U
set CoreName ap_simcore_fifo
set NumOfStage 2
set RegisteredInput 0
set DualClock 0
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_ramadr \
    op interface \
    ports { ramadr { I 64 vector } ramadr_ap_vld { I 1 bit } } \
} "
}
