; ModuleID = '/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/Vitis_HLS/Music/sound_operation/sound_operation/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_sound_operation_ir(%struct.ap_uint* %ramadr, %struct.ap_uint* %sdata, %struct.ap_uint* %opeout) local_unnamed_addr #0 {
entry:
  %ramadr_copy1 = alloca %struct.ap_uint, align 512
  %sdata_copy2 = alloca %struct.ap_uint, align 512
  %opeout_copy3 = alloca %struct.ap_uint, align 512
  call fastcc void @copy_in(%struct.ap_uint* %ramadr, %struct.ap_uint* nonnull align 512 %ramadr_copy1, %struct.ap_uint* %sdata, %struct.ap_uint* nonnull align 512 %sdata_copy2, %struct.ap_uint* %opeout, %struct.ap_uint* nonnull align 512 %opeout_copy3)
  call void @apatb_sound_operation_hw(%struct.ap_uint* %ramadr_copy1, %struct.ap_uint* %sdata_copy2, %struct.ap_uint* %opeout_copy3)
  call fastcc void @copy_out(%struct.ap_uint* %ramadr, %struct.ap_uint* nonnull align 512 %ramadr_copy1, %struct.ap_uint* %sdata, %struct.ap_uint* nonnull align 512 %sdata_copy2, %struct.ap_uint* %opeout, %struct.ap_uint* nonnull align 512 %opeout_copy3)
  ret void
}
...
declare void @apatb_sound_operation_hw(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)

define void @sound_operation_hw_stub_wrapper(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*) #6 {
entry:
  ...
  call void @sound_operation_hw_stub(%struct.ap_uint* %0, %struct.ap_uint* %1, %struct.ap_uint* %2)
...
declare void @sound_operation_hw_stub(%struct.ap_uint*, %struct.ap_uint*, %struct.ap_uint*)
