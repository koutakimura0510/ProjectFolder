...
__attribute__((sdx_kernel("sound_operation", 0))) void sound_operation(volatile u32 *ramadr, u32 *sdata, u32 *opeout)
{
#pragma HLS INTERFACE ap_ctrl_none port=return
# 9 "sound_operation.cpp"

#pragma HLS INTERFACE ap_none register port=cnt
# 9 "sound_operation.cpp"

#pragma HLS INTERFACE ap_none register port=opeout
# 9 "sound_operation.cpp"

#pragma HLS INTERFACE ap_none register port=sdata
# 9 "sound_operation.cpp"

#pragma HLS INTERFACE m_axi port=ramadr offset=slave bundle=ram num_read_outstanding=16 max_read_burst_length=32
# 9 "sound_operation.cpp"

#pragma HLS INTERFACE s_axilite port=ope
# 9 "sound_operation.cpp"

#pragma HLS TOP name=sound_operation
# 9 "sound_operation.cpp"

 sound_operation_label1:for (int i = 0; i < 5; i++) {
#pragma HLS DATAFLOW
# 10 "sound_operation.cpp"
