...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/SW/SW_Pmod/SW_Pmod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_Pmod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SW_Pmod.tcl -notrace
