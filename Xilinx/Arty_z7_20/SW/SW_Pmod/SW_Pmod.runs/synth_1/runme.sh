...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/Arty_z7_20/SW/SW_Pmod/SW_Pmod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SW_Pmod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SW_Pmod.tcl
