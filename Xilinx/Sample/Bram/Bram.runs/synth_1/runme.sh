...
HD_PWD='/home/kimura/workspace/ProjectFolder/Xilinx/Sample/Bram/Bram.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BramTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BramTop.tcl
