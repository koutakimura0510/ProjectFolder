...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/Memory/rom/RomInit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log romTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source romTop.tcl
