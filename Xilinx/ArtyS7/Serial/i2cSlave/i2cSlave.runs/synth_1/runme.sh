...
HD_PWD='/home/koutakimura/workspace/ProjectFolder/Xilinx/workspace/ArtyS7/Serial/i2cSlave/i2cSlave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2cTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2cTop.tcl
