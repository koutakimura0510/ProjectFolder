...
static const DtmDB dtmdb[] =
{
    ...
    {SOUND_ID_MINORIKO,         FILE_ACCESS_BGM_MINORIKO,           DRAM_SOUND_FIELD_ADDR_BASE,   SOUND_LOOP_OK,  12},
    ...
    {SOUND_ID_ENDING,           FILE_ACCESS_BGM_ENDING,             DRAM_SOUND_BATTLE_ADDR_BASE,  SOUND_LOOP_OK,  11},
    {SOUND_ID_MURA_1,           FILE_ACCESS_BGM_MURA_1,             DRAM_SOUND_FIELD_ADDR_BASE,   SOUND_LOOP_OK,  12},
