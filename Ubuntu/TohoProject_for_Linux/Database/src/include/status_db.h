...
void item_enchant_write(FILE *fp, FILE *byte)
{
	...
	error_print(ITEM_ENCHANT_DB_SIZE, ENCHANT_ITEM_END, "ITEM ENCHANT TOTAL NUMBER");
}
...
void item_condition_write(FILE *fp, FILE *byte)
{
	...
	error_print(ITEM_CONDITION_DB_SIZE, CONDITION_ITEM_END, "ITEM CONDITION TOTAL NUMBER");
}
